...
# Pattern to capture everything from <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-8">
# up to the <div className="flex gap-4 mb-6 border-b border-slate-700"> which is right after the KPIs block.

start = '<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-8">'
end = '<div className="flex gap-4 mb-6 border-b border-slate-700">'

start_idx = content.find(start)
end_idx = content.find(end)

new_kpis = '''<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-8">
