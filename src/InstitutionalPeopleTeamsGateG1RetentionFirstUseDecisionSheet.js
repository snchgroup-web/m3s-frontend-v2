...
const COPY = {
  FR: {
    eyebrow: 'PREMIERE UTILISATION · FICHE V1.0 CONFIRMÉE · 28-08-2026',
  ...
  EN: {
    eyebrow: 'FIRST USE · V1.0 CONFIRMED SHEET · 28 AUG 2026',
  ...
  DE: {
    eyebrow: 'ERSTNUTZUNG · BESTÄTIGTES BLATT V1.0 · 28.08.2026',
