...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.20 · 27-08-2026',
    ...
    nextControl: 'Prochain arbitrage : confirmer ou amender REF-01-G1-PRI-001 V0.1, puis indiquer séparément le premier dossier documentaire AUT à préparer ; aucune identité et aucun envoi ne sont autorisés, G1 reste ouverte et L2 fermé.',
    boundary: 'Statut : base fonctionnelle V1.0, cadrage V0.2 et proposition V1.0 confirmés ; ADR L0 V1.0 confirmé par REF-01-DEC-012 ; G0 clôturée ; fondations L1 V0.1 testées localement ; quatre principes G1 confirmés ; fiche de preuve V1.0, paquet de collecte V1.0, fiche de sollicitation V1.0, profils destinataires V1.0, fiche nominative V1.0, registre d’autorisation V1.0 et gabarit unitaire IDN-001 V1.0 confirmés ; PRI-001 V0.1 préparé avec zéro dossier AUT priorisé, zéro preuve reçue, zéro destinataire nommé, zéro autorisation accordée, zéro demande envoyée, zéro fournisseur retenu et L2 fermé ; décisions sur le lot : 17 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat API RH-001, Annuaire interne, Team/Agent, cadrage GED, backend Node.js/Express et BigQuery observés, décisions REF-01-DEC-001 à REF-01-DEC-020, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0 et fondations L1 candidates publiées par la PR backend #46 au commit cf35120.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.20 · 27 AUG 2026',
    ...
    nextControl: 'Next decision: confirm or amend REF-01-G1-PRI-001 V0.1, then state separately which documentary AUT file should be prepared first; no identity or send is authorised, G1 remains open and L2 closed.',
    boundary: 'Status: functional baseline V1.0, framing V0.2 and proposal V1.0 confirmed; L0 ADR V1.0 confirmed through REF-01-DEC-012; G0 closed; L1 foundations V0.1 tested locally; four G1 principles confirmed; evidence sheet V1.0, collection package V1.0, request sheet V1.0, recipient profiles V1.0, named-recipient sheet V1.0, authorisation register V1.0 and individual template IDN-001 V1.0 confirmed; PRI-001 V0.1 prepared with zero prioritised AUT files, zero evidence received, zero named recipients, zero authorisations granted, zero requests sent, zero selected providers and L2 closed; package decisions: 17; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: RH-001 API contract, Internal Directory, Team/Agent, DMS framing, observed Node.js/Express backend and BigQuery, decisions REF-01-DEC-001 through REF-01-DEC-020, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0 and candidate L1 foundations published through backend PR #46 at commit cf35120.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.20 · 27.08.2026',
    ...
    nextControl: 'Nächster Entscheid: REF-01-G1-PRI-001 V0.1 bestätigen oder ändern und danach getrennt angeben, welche dokumentarische AUT-Akte zuerst vorbereitet werden soll; keine Identität oder Sendung ist autorisiert, G1 bleibt offen und L2 geschlossen.',
    boundary: 'Stand: funktionale Basis V1.0, Ausgestaltung V0.2 und Vorschlag V1.0 bestätigt; L0-ADR V1.0 mit REF-01-DEC-012 bestätigt; G0 geschlossen; L1-Grundlagen V0.1 lokal geprüft; vier G1-Prinzipien bestätigt; Nachweisblatt V1.0, Sammlungspaket V1.0, Anfrageblatt V1.0, Empfängerprofile V1.0, Blatt für benannte Empfänger V1.0, Autorisierungsregister V1.0 und Einzelvorlage IDN-001 V1.0 bestätigt; PRI-001 V0.1 mit null priorisierten AUT-Akten vorbereitet, null erhaltene Nachweise, null benannte Empfänger, null erteilte Autorisierungen, null gesendete Anfragen, null gewählte Anbieter und L2 geschlossen; Paketentscheide: 17; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: RH-001-API-Vertrag, Internes Verzeichnis, Team/Agent, DMS-Rahmen, beobachtetes Node.js/Express-Backend und BigQuery, REF-01-DEC-001 bis REF-01-DEC-020, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0 und mit Backend-PR #46 am Commit cf35120 veröffentlichte Kandidatengrundlagen L1.'
  }
};
