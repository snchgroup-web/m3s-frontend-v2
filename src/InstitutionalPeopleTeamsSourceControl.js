...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.2 · 26-08-2026',
    ...
    nextControl: 'Prochain arbitrage : confirmer l’ordre des quatre vagues et autoriser la préparation documentaire de REF-01-ML-001, sans implémentation.',
    boundary: 'Statut : lot A confirmé dans REF-01 V1.1 ; priorisation V0.1 proposée dans REF-01 V1.2 ; décisions sur le lot : 2 ; sources maîtresses désignées : 0.',
  ...
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.2 · 26 AUG 2026',
    ...
    nextControl: 'Next arbitration: confirm the four-wave order and authorise documentary preparation of REF-01-ML-001, without implementation.',
    boundary: 'Status: package A confirmed in REF-01 V1.1; V0.1 prioritisation proposed in REF-01 V1.2; package decisions: 2; designated master sources: 0.',
  ...
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.2 · 26.08.2026',
    ...
    nextControl: 'Nächster Entscheid: Reihenfolge der vier Wellen bestätigen und die dokumentarische Vorbereitung von REF-01-ML-001 ohne Umsetzung autorisieren.',
    boundary: 'Stand: Paket A in REF-01 V1.1 bestätigt; Priorisierung V0.1 in REF-01 V1.2 vorgeschlagen; Entscheide zum Paket: 2; bestimmte Masterquellen: 0.',
