...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.81 · 31-08-2026',
    ...
    nextControl: 'Exécuter la collecte documentaire interne autorisée par DEC-078, contrôler séparément chaque pièce et maintenir toute requalification en attente de preuve recevable ; ne lancer aucun contact externe, lot réel ni L2.',
    boundary: 'Statut : REF-01-DEC-077 clôt le lot synthétique ; REF-01-DEC-078 autorise COL-003 V1.1 à collecter en interne les preuves des treize écarts. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes ; pièces reçues ou acceptées : 0/13. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, entrée réelle, import, connecteur, automatisme, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 75 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-078, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, moteur et tests synthétiques du pilote, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et validations synthétiques locales réussies les 30 et 31-08-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.81 · 31 AUG 2026',
    ...
    nextControl: 'Run the internal documentary collection authorised by DEC-078, control each record separately and keep every requalification pending admissible evidence; launch no external contact, real package or L2.',
    boundary: 'Status: REF-01-DEC-077 closes the synthetic package; REF-01-DEC-078 authorises COL-003 V1.1 to collect evidence for the thirteen gaps internally. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open; records received or accepted: 0/13. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real entries, imports, connectors, automations, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 75; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-078, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetic pilot engine and tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and successful local synthetic validations on 30 and 31 Aug 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.81 · 31.08.2026',
    ...
    nextControl: 'Die durch DEC-078 autorisierte interne Dokumentensammlung ausführen, jede Unterlage getrennt kontrollieren und jede Neueinstufung bis zu einem zulässigen Nachweis aussetzen; keinen externen Kontakt, kein reales Los und kein L2 starten.',
    boundary: 'Stand: REF-01-DEC-077 schliesst das synthetische Los; REF-01-DEC-078 autorisiert COL-003 V1.1, die Nachweise der dreizehn Lücken intern zu sammeln. Alle 22/22 Werte behalten ihre Qualifizierung: 9 nur in synthetischem Umfang, 8 teilweise und 5 offen; erhaltene oder angenommene Unterlagen: 0/13. Kein Produktionswert ist bestimmt; 0/6 G1-Bedingungen sind schliessbar, G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Eingänge, Importe, Connectoren, Automatismen, reale Inhaber, Namensmandate, Delegationen, C3/C4/C5-Zugriffe, Produktivmigrationen, reale Wiederherstellungen, erstellte DMS-Referenzen, Worker oder Alarme; Paketentscheide: 75; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: REF-01-DEC-001 bis REF-01-DEC-078, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetisches Pilotmodul und Tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, SQL-Up- und Down-Migrationen, scripts/validateRef01Migrations.mjs sowie erfolgreiche lokale synthetische Validierungen vom 30. und 31.08.2026; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
