...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.84 · 01-09-2026',
    ...
    nextControl: 'Faire confirmer ou amender REF-01-G1-ATT-001 V0.1 comme règle d’attente probatoire gouvernée. Ne reprendre les treize écarts qu’en présence d’une nouvelle preuve recevable ou d’une contradiction documentée ; ne lancer aucun contact externe, lot réel ni L2.',
    boundary: 'Statut : REF-01-DEC-081 confirme COL-004 V1.0 comme relevé gouverné de la recherche interne bornée. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes ; preuves attendues acceptées : 0/13. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, entrée réelle, import, connecteur, automatisme, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 78 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-081, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V1.0, ATT-001 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, moteur et tests synthétiques du pilote, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et recherche interne bornée du 01-09-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.84 · 1 SEP 2026',
    ...
    nextControl: 'Have REF-01-G1-ATT-001 V0.1 confirmed or amended as the governed evidence-wait rule. Resume the thirteen gaps only when new admissible evidence or a documented contradiction appears; launch no external contact, real package or L2.',
    boundary: 'Status: REF-01-DEC-081 confirms COL-004 V1.0 as the governed report of the bounded internal search. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open; accepted expected proofs: 0/13. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real entries, imports, connectors, automations, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 78; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-081, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V1.0, ATT-001 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetic pilot engine and tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and the bounded internal search of 1 Sep 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.84 · 01.09.2026',
    ...
    nextControl: 'REF-01-G1-ATT-001 V0.1 als Regel für gesteuertes Nachweiswarten bestätigen oder ändern lassen. Die dreizehn Lücken nur bei neuem zulässigem Nachweis oder dokumentiertem Widerspruch wiederaufnehmen; keinen externen Kontakt, kein reales Los und kein L2 starten.',
    boundary: 'Stand: REF-01-DEC-081 bestätigt COL-004 V1.0 als gesteuertes Protokoll der begrenzten internen Suche. Alle 22/22 Werte behalten ihre Qualifizierung: 9 nur in synthetischem Umfang, 8 teilweise und 5 offen; angenommene erwartete Nachweise: 0/13. Kein Produktionswert ist bestimmt; 0/6 G1-Bedingungen sind schliessbar, G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Eingänge, Importe, Connectoren, Automatismen, reale Inhaber, Namensmandate, Delegationen, C3/C4/C5-Zugriffe, Produktivmigrationen, reale Wiederherstellungen, erstellte DMS-Referenzen, Worker oder Alarme; Paketentscheide: 78; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: REF-01-DEC-001 bis REF-01-DEC-081, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V1.0, ATT-001 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetisches Pilotmodul und Tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, SQL-Up- und Down-Migrationen, scripts/validateRef01Migrations.mjs sowie die begrenzte interne Suche vom 01.09.2026; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
