...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.31 · 27-08-2026',
    ...
    nextControl: 'Arbitrage groupé requis : confirmer ou amender REF-01-G1-PKG-01-001 V0.1 et REF-01-G1-PKG-02-001 V0.1 ; une confirmation validera seulement les deux matrices documentaires, sans action réelle.',
    boundary: 'Statut : REF-01-DEC-029 confirme PKG-001 V1.0 comme registre gouverné. PKG-01-001 V0.1 et PKG-02-001 V0.1 préparent deux supports candidats ; cinq conditions restent partiellement documentées, zéro clôturable et L2 fermé. Zéro accès réel, preuve réelle reçue, prix contractuel, destinataire nommé, demande envoyée ou fournisseur retenu ; décisions sur le lot : 26 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat API RH-001, Annuaire interne, Team/Agent, cadrage GED, backend Node.js/Express et BigQuery observés, décisions REF-01-DEC-001 à REF-01-DEC-029, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0 et supports candidats PKG-01-001/PKG-02-001 V0.1.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.31 · 27 AUG 2026',
    ...
    nextControl: 'One grouped decision is required: confirm or amend REF-01-G1-PKG-01-001 V0.1 and REF-01-G1-PKG-02-001 V0.1; confirmation will validate only both documentary matrices, with no real action.',
    boundary: 'Status: REF-01-DEC-029 confirms PKG-001 V1.0 as the governed register. PKG-01-001 V0.1 and PKG-02-001 V0.1 prepare two candidate supports; five conditions remain partially documented, zero closable and L2 closed. Zero real access, real evidence received, contractual price, named recipients, sent requests or selected providers; package decisions: 26; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: RH-001 API contract, Internal Directory, Team/Agent, DMS framing, observed Node.js/Express backend and BigQuery, decisions REF-01-DEC-001 through REF-01-DEC-029, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0 and candidate supports PKG-01-001/PKG-02-001 V0.1.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.31 · 27.08.2026',
    ...
    nextControl: 'Ein gebündelter Entscheid ist erforderlich: REF-01-G1-PKG-01-001 V0.1 und REF-01-G1-PKG-02-001 V0.1 bestätigen oder ändern; die Bestätigung validiert nur beide Dokumentmatrizen ohne reale Aktion.',
    boundary: 'Stand: REF-01-DEC-029 bestätigt PKG-001 V1.0 als gesteuertes Register. PKG-01-001 V0.1 und PKG-02-001 V0.1 bereiten zwei Kandidatenträger vor; fünf Bedingungen bleiben teilweise dokumentiert, null schliessbar und L2 geschlossen. Null Realzugriffe, erhaltene Realnachweise, Vertragspreise, benannte Empfänger, versandte Anfragen oder gewählte Anbieter; Paketentscheide: 26; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: RH-001-API-Vertrag, Internes Verzeichnis, Team/Agent, DMS-Rahmen, beobachtetes Node.js/Express-Backend und BigQuery, REF-01-DEC-001 bis REF-01-DEC-029, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0 und Kandidatenträger PKG-01-001/PKG-02-001 V0.1.'
  }
};
