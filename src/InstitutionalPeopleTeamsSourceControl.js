...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.74 · 30-08-2026',
    ...
    nextControl: 'Confirmer ou amender REF-01-G1-AUT-002 V0.1 comme cadre des cinq dossiers d’autorisation vides, sans autoriser ni contacter personne. Toute identité, adresse, affectation et tout canal resteront soumis à des validations distinctes.',
    boundary: 'Statut : REF-01-DEC-071 confirme NAM-002 V1.0 comme cinq emplacements nominatifs vides, sans identité ni contact. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes tant que les preuves ne sont pas reçues. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 68 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-071, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-002 V0.1, PGM-CPK-001 V0.1, M3S-INB-001 V0.1, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et validation synthétique locale réussie le 30-08-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.74 · 30 AUG 2026',
    ...
    nextControl: 'Confirm or amend REF-01-G1-AUT-002 V0.1 as the framework for the five empty authorisation files, without authorising or contacting anyone. Every identity, address, assignment and channel will remain subject to separate validations.',
    boundary: 'Status: REF-01-DEC-071 confirms NAM-002 V1.0 as five empty named-recipient slots without identity or contact. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open until evidence is received. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 68; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-071, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-002 V0.1, PGM-CPK-001 V0.1, M3S-INB-001 V0.1, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and successful local synthetic validation on 30 Aug 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.74 · 30.08.2026',
