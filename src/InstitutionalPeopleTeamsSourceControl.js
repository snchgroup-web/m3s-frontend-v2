...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.37 · 27-08-2026',
    ...
    nextControl: 'Arbitrage requis : confirmer ou amender REF-01-G1-COL-002 V0.1 ; une confirmation acceptera seulement le protocole sans autoriser sa collecte ni ses tests.',
    boundary: 'Statut : REF-01-DEC-035 confirme EVD-002 V1.0. Les six preuves attendues et leurs critères sont gouvernés ; zéro preuve est reçue ou testée, zéro collecte est autorisée, G1 reste ouverte et L2 fermé. Zéro accès réel, worker actif, alerte envoyée, rejeu exécuté ou fournisseur retenu ; décisions sur le lot : 32 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat API RH-001, Annuaire interne, Team/Agent, cadrage GED, backend Node.js/Express et BigQuery observés, décisions REF-01-DEC-001 à REF-01-DEC-035, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 à PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0 et protocole candidat REF-01-G1-COL-002 V0.1.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.37 · 27 AUG 2026',
    ...
    nextControl: 'One decision is required: confirm or amend REF-01-G1-COL-002 V0.1; confirmation will accept only the protocol without authorising collection or tests.',
    boundary: 'Status: REF-01-DEC-035 confirms EVD-002 V1.0. All six expected evidence items and their criteria are governed; zero evidence is received or tested, zero collection is authorised, G1 remains open and L2 closed. Zero real access, active workers, sent alerts, executed replays or selected providers; package decisions: 32; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: RH-001 API contract, Internal Directory, Team/Agent, DMS framing, observed Node.js/Express backend and BigQuery, decisions REF-01-DEC-001 through REF-01-DEC-035, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 through PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0 and candidate protocol REF-01-G1-COL-002 V0.1.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.37 · 27.08.2026',
    ...
    nextControl: 'Ein Entscheid ist erforderlich: REF-01-G1-COL-002 V0.1 bestätigen oder ändern; die Bestätigung nimmt nur das Protokoll an, ohne Sammlung oder Tests zu erlauben.',
    boundary: 'Stand: REF-01-DEC-035 bestätigt EVD-002 V1.0. Alle sechs erwarteten Nachweise und ihre Kriterien sind gesteuert; null Nachweise sind erhalten oder getestet, null Sammlungen autorisiert, G1 bleibt offen und L2 geschlossen. Null Realzugriffe, aktive Worker, gesendete Alarme, ausgeführte Wiederholungen oder gewählte Anbieter; Paketentscheide: 32; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: RH-001-API-Vertrag, Internes Verzeichnis, Team/Agent, DMS-Rahmen, beobachtetes Node.js/Express-Backend und BigQuery, REF-01-DEC-001 bis REF-01-DEC-035, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 bis PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0 und Kandidatenprotokoll REF-01-G1-COL-002 V0.1.'
  }
};
