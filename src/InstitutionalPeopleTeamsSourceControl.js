...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.12 · 26-08-2026',
    ...
    nextControl: 'Prochain contrôle : documenter les sept preuves du point PostgreSQL/restauration amendé par REF-01-DEC-013, puis demander sa confirmation séparée ; G1 reste ouverte et L2 fermé.',
    boundary: 'Statut : base fonctionnelle V1.0, cadrage V0.2 et proposition V1.0 confirmés ; ADR L0 V1.0 confirmé par REF-01-DEC-012 ; G0 clôturée ; fondations L1 V0.1 testées localement ; quatre principes G1 confirmés, point PostgreSQL amendé et L2 maintenu fermé par REF-01-DEC-013 ; décisions sur le lot : 10 ; sources maîtresses désignées : 0 ; changements en production : 0.',
  ...
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.12 · 26 AUG 2026',
    ...
    nextControl: 'Next control: document the seven evidence items for the PostgreSQL/restoration point amended through REF-01-DEC-013, then request its separate confirmation; G1 remains open and L2 closed.',
    boundary: 'Status: functional baseline V1.0, framing V0.2 and proposal V1.0 confirmed; L0 ADR V1.0 confirmed through REF-01-DEC-012; G0 closed; L1 foundations V0.1 tested locally; four G1 principles confirmed, PostgreSQL point amended and L2 kept closed through REF-01-DEC-013; package decisions: 10; designated master sources: 0; production changes: 0.',
  ...
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.12 · 26.08.2026',
    ...
    nextControl: 'Nächste Kontrolle: die sieben Nachweise für den mit REF-01-DEC-013 geänderten PostgreSQL-/Restore-Punkt dokumentieren und getrennt bestätigen lassen; G1 bleibt offen und L2 geschlossen.',
    boundary: 'Stand: funktionale Basis V1.0, Ausgestaltung V0.2 und Vorschlag V1.0 bestätigt; L0-ADR V1.0 mit REF-01-DEC-012 bestätigt; G0 geschlossen; L1-Grundlagen V0.1 lokal geprüft; vier G1-Prinzipien bestätigt, PostgreSQL-Punkt geändert und L2 mit REF-01-DEC-013 geschlossen gehalten; Paketentscheide: 10; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
