...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.58 · 29-08-2026',
    ...
    nextControl: 'Confirmer ou amender AUT-02-02-007 V0.1, les portes d ouverture d une habilitation.',
    boundary: 'Statut : REF-01-DEC-055 confirme AUT-02-02-006 V1.0 comme registre documentaire vide. AUT-02-02-007 V0.1 prépare uniquement six portes d admissibilité ; G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, titulaire réel, mandat nominatif, délégation, exception, accès C3/C4/C5, worker, alerte, rejeu ou fournisseur ; décisions sur le lot : 52 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat candidat API RH-001 du lot L1 isolé, fixture C2 synthétique et tests locaux du handler, Annuaire interne C2, Team/Agent, cadrage GED, décisions REF-01-DEC-001 à REF-01-DEC-055, matrices AUT-02-03-002/AUT-02-02-002 V1.0, cadre LEGAL AUT-02-03-003 V1.0, désignation AUT-02-03-004 V1.0, responsabilités/déclencheurs AUT-02-03-005 V1.0, protocoles de revue AUT-02-03-006 V1.0, registre vide AUT-02-03-007 V1.0, portes AUT-02-03-008 V1.0, fiche de décision AUT-02-03-009 V1.0, protocole AUT-02-03-010 V1.0, fiche GO/NO-GO AUT-02-03-011 V1.0, modèle Rôles et moindre privilège AUT-02-02-003 V1.0, matrice Droits testés et refus AUT-02-02-004 V1.0, protocole Attribution et retrait AUT-02-02-005 V1.0, registre d habilitations AUT-02-02-006 V1.0 et portes d ouverture AUT-02-02-007 V0.1 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.58 · 29 AUG 2026',
    ...
    nextControl: 'Confirm or amend AUT-02-02-007 V0.1, the access-record opening gates.',
    boundary: 'Status: REF-01-DEC-055 confirms AUT-02-02-006 V1.0 as an empty documentary register. AUT-02-02-007 V0.1 only prepares six admissibility gates; G1 remains open and L2 closed. Zero new rights, active records, real holders, named mandates, delegations, exceptions, C3/C4/C5 access, workers, alerts, replays or providers; package decisions: 52; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: isolated L1 candidate RH-001 API contract, synthetic C2 fixture and local handler tests, C2 Internal Directory, Team/Agent, DMS framing, decisions REF-01-DEC-001 through REF-01-DEC-055, AUT-02-03-002/AUT-02-02-002 V1.0 matrices, AUT-02-03-003 V1.0 LEGAL framework, AUT-02-03-004 V1.0 designation, AUT-02-03-005 V1.0 ownership/triggers, AUT-02-03-006 V1.0 review protocols, AUT-02-03-007 V1.0 empty register, AUT-02-03-008 V1.0 gates, AUT-02-03-009 V1.0 decision sheet, AUT-02-03-010 V1.0 protocol, AUT-02-03-011 V1.0 GO/NO-GO sheet, AUT-02-02-003 V1.0 Roles and least privilege model, AUT-02-02-004 V1.0 Tested rights and denials matrix, AUT-02-02-005 V1.0 Grant and withdrawal protocol, AUT-02-02-006 V1.0 access-rights register and AUT-02-02-007 V0.1 opening gates; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.58 · 29.08.2026',
    ...
    nextControl: 'AUT-02-02-007 V0.1, die Öffnungstore eines Berechtigungseintrags, bestätigen oder ändern.',
    boundary: 'Stand: REF-01-DEC-055 bestätigt AUT-02-02-006 V1.0 als leeres Dokumentationsregister. AUT-02-02-007 V0.1 bereitet nur sechs Zulässigkeitstore vor; G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Inhaber, Namensmandate, Delegationen, Ausnahmen, C3/C4/C5-Zugriffe, Worker, Alarme, Wiederholungen oder Anbieter; Paketentscheide: 52; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: isolierter RH-001-API-Kandidatenvertrag des L1-Loses, synthetische C2-Fixture und lokale Handler-Tests, internes C2-Verzeichnis, Team/Agent, DMS-Rahmen, REF-01-DEC-001 bis REF-01-DEC-055, Matrizen AUT-02-03-002/AUT-02-02-002 V1.0, LEGAL-Rahmen AUT-02-03-003 V1.0, Zuordnung AUT-02-03-004 V1.0, Verantwortung/Auslöser AUT-02-03-005 V1.0, Prüfprotokolle AUT-02-03-006 V1.0, leeres Register AUT-02-03-007 V1.0, Tore AUT-02-03-008 V1.0, Entscheidblatt AUT-02-03-009 V1.0, Protokoll AUT-02-03-010 V1.0, GO/NO-GO-Blatt AUT-02-03-011 V1.0, Modell AUT-02-02-003 V1.0 Rollen und geringste Berechtigung, Matrix AUT-02-02-004 V1.0 Getestete Rechte und Ablehnungen, Protokoll AUT-02-02-005 V1.0 Zuweisung und Entzug, Berechtigungsregister AUT-02-02-006 V1.0 sowie Öffnungstore AUT-02-02-007 V0.1; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
