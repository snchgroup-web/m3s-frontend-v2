...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.79 · 31-08-2026',
    ...
    nextControl: 'Relire humainement les six résultats synthétiques M3S-INB-002 et décider séparément de leur acceptation ; ne lancer aucun lot réel ni L2.',
    boundary: 'Statut : REF-01-DEC-076 enregistre dans M3S-INB-003 V1.1 le GO limité aux six cas fictifs M3S-INB-002 ; 1/2 option est sélectionnée, 6/6 cas sont autorisés et exécutés, 5/5 critères techniques sont vérifiés et la relecture humaine reste ouverte. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes tant que les preuves ne sont pas reçues. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, entrée réelle, import, connecteur, automatisme, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 73 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-076, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, moteur et tests synthétiques du pilote, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et validations synthétiques locales réussies les 30 et 31-08-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.79 · 31 AUG 2026',
    ...
    nextControl: 'Human-review the six synthetic M3S-INB-002 results and decide separately whether to accept them; launch no real or L2 package.',
    boundary: 'Status: REF-01-DEC-076 records in M3S-INB-003 V1.1 the limited GO for six fictional M3S-INB-002 cases; 1/2 option is selected, 6/6 cases are authorised and run, 5/5 technical criteria are verified and human review remains open. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open until evidence is received. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real entries, imports, connectors, automations, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 73; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-076, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetic pilot engine and tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and successful local synthetic validations on 30 and 31 Aug 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.79 · 31.08.2026',
    ...
    nextControl: 'Die sechs synthetischen M3S-INB-002-Ergebnisse menschlich prüfen und getrennt über ihre Annahme entscheiden; kein reales oder L2-Los starten.',
    boundary: 'Stand: REF-01-DEC-076 erfasst in M3S-INB-003 V1.1 das begrenzte GO für sechs fiktive M3S-INB-002-Fälle; 1/2 Option ist gewählt, 6/6 Fälle sind autorisiert und ausgeführt, 5/5 technische Kriterien sind geprüft und die menschliche Prüfung bleibt offen. Alle 22/22 Werte behalten ihre Qualifizierung: 9 nur in synthetischem Umfang, 8 teilweise und 5 offen, bis Nachweise vorliegen. Kein Produktionswert ist bestimmt; 0/6 G1-Bedingungen sind schliessbar, G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Eingänge, Importe, Connectoren, Automatismen, reale Inhaber, Namensmandate, Delegationen, C3/C4/C5-Zugriffe, Produktivmigrationen, reale Wiederherstellungen, erstellte DMS-Referenzen, Worker oder Alarme; Paketentscheide: 73; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: REF-01-DEC-001 bis REF-01-DEC-076, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetisches Pilotmodul und Tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, SQL-Up- und Down-Migrationen, scripts/validateRef01Migrations.mjs sowie erfolgreiche lokale synthetische Validierungen vom 30. und 31.08.2026; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
