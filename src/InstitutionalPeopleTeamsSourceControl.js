...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.33 · 27-08-2026',
    ...
    nextControl: 'Arbitrage requis : confirmer ou amender REF-01-G1-PKG-04-001 V0.1 ; une confirmation validera seulement la procédure documentaire migration et retour arrière, sans action réelle.',
    boundary: 'Statut : REF-01-DEC-031 confirme PKG-03-001 V1.0 comme grille gouvernée. PKG-04-001 V0.1 prépare une procédure candidate de migration et retour arrière ; cinq conditions restent partiellement documentées, zéro clôturable et L2 fermé. Zéro accès réel, preuve réelle reçue, prix contractuel, environnement touché, migration appliquée ou fournisseur retenu ; décisions sur le lot : 28 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat API RH-001, Annuaire interne, Team/Agent, cadrage GED, backend Node.js/Express et BigQuery observés, décisions REF-01-DEC-001 à REF-01-DEC-031, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001/PKG-02-001/PKG-03-001 V1.0 et support candidat PKG-04-001 V0.1.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.33 · 27 AUG 2026',
    ...
    nextControl: 'One decision is required: confirm or amend REF-01-G1-PKG-04-001 V0.1; confirmation will validate only the migration and rollback documentary procedure, with no real action.',
    boundary: 'Status: REF-01-DEC-031 confirms PKG-03-001 V1.0 as a governed grid. PKG-04-001 V0.1 prepares a candidate migration and rollback procedure; five conditions remain partially documented, zero closable and L2 closed. Zero real access, real evidence received, contractual price, touched environment, applied migration or selected provider; package decisions: 28; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: RH-001 API contract, Internal Directory, Team/Agent, DMS framing, observed Node.js/Express backend and BigQuery, decisions REF-01-DEC-001 through REF-01-DEC-031, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001/PKG-02-001/PKG-03-001 V1.0 and candidate support PKG-04-001 V0.1.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.33 · 27.08.2026',
    ...
    nextControl: 'Ein Entscheid ist erforderlich: REF-01-G1-PKG-04-001 V0.1 bestätigen oder ändern; die Bestätigung validiert nur das Dokumentverfahren Migration und Rollback ohne reale Aktion.',
    boundary: 'Stand: REF-01-DEC-031 bestätigt PKG-03-001 V1.0 als gesteuertes Raster. PKG-04-001 V0.1 bereitet ein Kandidatenverfahren für Migration und Rollback vor; fünf Bedingungen bleiben teilweise dokumentiert, null schliessbar und L2 geschlossen. Null Realzugriffe, erhaltene Realnachweise, Vertragspreise, berührte Umgebungen, angewandte Migrationen oder gewählte Anbieter; Paketentscheide: 28; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: RH-001-API-Vertrag, Internes Verzeichnis, Team/Agent, DMS-Rahmen, beobachtetes Node.js/Express-Backend und BigQuery, REF-01-DEC-001 bis REF-01-DEC-031, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001/PKG-02-001/PKG-03-001 V1.0 und Kandidatenträger PKG-04-001 V0.1.'
  }
};
