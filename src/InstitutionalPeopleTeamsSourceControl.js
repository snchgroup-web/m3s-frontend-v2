...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.11 · 26-08-2026',
    ...
    nextControl: 'Prochain arbitrage : examiner REF-01-G1-ARB-001 V0.1 puis confirmer, amender ou rejeter séparément les six propositions ; G1 reste ouverte et L2 fermé.',
    boundary: 'Statut : base fonctionnelle V1.0, cadrage V0.2 et proposition V1.0 confirmés ; ADR L0 V1.0 confirmé par REF-01-DEC-012 ; G0 clôturée ; fondations L1 V0.1 testées localement ; revue G1 V0.1 et base d’arbitrage V0.1 préparées ; décisions sur le lot : 9 ; sources maîtresses désignées : 0 ; changements en production : 0.',
  ...
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.11 · 26 AUG 2026',
    ...
    nextControl: 'Next review: examine REF-01-G1-ARB-001 V0.1, then confirm, amend or reject the six proposals separately; G1 remains open and L2 closed.',
    boundary: 'Status: functional baseline V1.0, framing V0.2 and proposal V1.0 confirmed; L0 ADR V1.0 confirmed through REF-01-DEC-012; G0 closed; L1 foundations V0.1 tested locally; G1 review V0.1 and decision basis V0.1 prepared; package decisions: 9; designated master sources: 0; production changes: 0.',
  ...
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.11 · 26.08.2026',
    ...
    nextControl: 'Nächster Entscheid: REF-01-G1-ARB-001 V0.1 prüfen und die sechs Vorschläge einzeln bestätigen, ändern oder ablehnen; G1 bleibt offen und L2 geschlossen.',
    boundary: 'Stand: funktionale Basis V1.0, Ausgestaltung V0.2 und Vorschlag V1.0 bestätigt; L0-ADR V1.0 mit REF-01-DEC-012 bestätigt; G0 geschlossen; L1-Grundlagen V0.1 lokal geprüft; G1-Prüfung V0.1 und Entscheidungsgrundlage V0.1 vorbereitet; Paketentscheide: 9; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
