...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.77 · 31-08-2026',
    ...
    nextControl: 'Préparer M3S-INB-003 V0.1 comme fiche GO/NO-GO vide, sans lancer les six cas fictifs ni ouvrir une capacité opérationnelle.',
    boundary: 'Statut : REF-01-DEC-074 confirme M3S-INB-002 V1.0 uniquement comme protocole fictif, avec 0/6 cas exécuté. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes tant que les preuves ne sont pas reçues. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, entrée réelle, import, connecteur, automatisme, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 71 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-074, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et validation synthétique locale réussie le 30-08-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.77 · 31 AUG 2026',
    ...
    nextControl: 'Prepare M3S-INB-003 V0.1 as an empty GO/NO-GO form, without launching the six fictional cases or opening an operational capability.',
    boundary: 'Status: REF-01-DEC-074 confirms M3S-INB-002 V1.0 only as a fictional protocol, with 0/6 cases run. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open until evidence is received. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real entries, imports, connectors, automations, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 71; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-074, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and successful local synthetic validation on 30 Aug 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.77 · 31.08.2026',
    ...
    nextControl: 'M3S-INB-003 V0.1 als leeres GO/NO-GO-Blatt vorbereiten, ohne die sechs fiktiven Fälle zu starten oder eine operative Fähigkeit zu öffnen.',
    boundary: 'Stand: REF-01-DEC-074 bestätigt M3S-INB-002 V1.0 nur als fiktives Protokoll, mit 0/6 ausgeführten Fällen. Alle 22/22 Werte behalten ihre Qualifizierung: 9 nur in synthetischem Umfang, 8 teilweise und 5 offen, bis Nachweise vorliegen. Kein Produktionswert ist bestimmt; 0/6 G1-Bedingungen sind schliessbar, G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Eingänge, Importe, Connectoren, Automatismen, reale Inhaber, Namensmandate, Delegationen, C3/C4/C5-Zugriffe, Produktivmigrationen, reale Wiederherstellungen, erstellte DMS-Referenzen, Worker oder Alarme; Paketentscheide: 71; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: REF-01-DEC-001 bis REF-01-DEC-074, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, SQL-Up- und Down-Migrationen, scripts/validateRef01Migrations.mjs sowie erfolgreiche lokale synthetische Validierung vom 30.08.2026; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
