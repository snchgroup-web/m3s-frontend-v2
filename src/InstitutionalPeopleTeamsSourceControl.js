...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.38 · 28-08-2026',
    ...
    nextControl: 'Arbitrage requis : confirmer ou amender REF-01-G1-AUT-002 V0.1 ; une confirmation acceptera seulement le registre sans autoriser aucun de ses six dossiers.',
    boundary: 'Statut : REF-01-DEC-036 confirme COL-002 V1.0. Les six circuits et leurs arrêts sont gouvernés ; zéro autorisation, preuve reçue ou testée, collecte ou test réel, G1 reste ouverte et L2 fermé. Zéro accès réel, worker actif, alerte envoyée, rejeu exécuté ou fournisseur retenu ; décisions sur le lot : 33 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : contrat API RH-001, Annuaire interne, Team/Agent, cadrage GED, backend Node.js/Express et BigQuery observés, décisions REF-01-DEC-001 à REF-01-DEC-036, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 à PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0, COL-002 V1.0 et registre candidat REF-01-G1-AUT-002 V0.1.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.38 · 28 AUG 2026',
    ...
    nextControl: 'One decision is required: confirm or amend REF-01-G1-AUT-002 V0.1; confirmation will accept only the register without authorising any of its six files.',
    boundary: 'Status: REF-01-DEC-036 confirms COL-002 V1.0. All six routes and stops are governed; zero authorisations, received or tested evidence, real collections or tests, G1 remains open and L2 closed. Zero real access, active workers, sent alerts, executed replays or selected providers; package decisions: 33; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: RH-001 API contract, Internal Directory, Team/Agent, DMS framing, observed Node.js/Express backend and BigQuery, decisions REF-01-DEC-001 through REF-01-DEC-036, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 through PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0, COL-002 V1.0 and candidate register REF-01-G1-AUT-002 V0.1.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.38 · 28.08.2026',
    ...
    nextControl: 'Ein Entscheid ist erforderlich: REF-01-G1-AUT-002 V0.1 bestätigen oder ändern; die Bestätigung nimmt nur das Register an, ohne eine seiner sechs Akten zu autorisieren.',
    boundary: 'Stand: REF-01-DEC-036 bestätigt COL-002 V1.0. Alle sechs Wege und Stopps sind gesteuert; null Autorisierungen, erhaltene oder getestete Nachweise, reale Sammlungen oder Tests, G1 bleibt offen und L2 geschlossen. Null Realzugriffe, aktive Worker, gesendete Alarme, ausgeführte Wiederholungen oder gewählte Anbieter; Paketentscheide: 33; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: RH-001-API-Vertrag, Internes Verzeichnis, Team/Agent, DMS-Rahmen, beobachtetes Node.js/Express-Backend und BigQuery, REF-01-DEC-001 bis REF-01-DEC-036, REF-01-IMP-001 V1.0, REF-01-ADR-001 V1.0, RES-001 V1.0, CD-001 V1.0, AUT-C-001/AUT-D-001 V1.0, REV-002 V1.0, PLN-001 V1.0, PKG-001 V1.0, PKG-01-001 bis PKG-05-001 V1.0, REV-003 V1.0, EVD-002 V1.0, COL-002 V1.0 und Kandidatenregister REF-01-G1-AUT-002 V0.1.'
  }
};
