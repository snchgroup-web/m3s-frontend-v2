...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.83 · 01-09-2026',
    ...
    nextControl: 'Faire confirmer ou amender REF-01-G1-COL-004 V0.1 comme relevé groupé de la recherche interne bornée. Maintenir toute requalification en attente d’une preuve de production recevable ; ne lancer aucun contact externe, lot réel ni L2.',
    boundary: 'Statut : REF-01-DEC-080 confirme REV-006 V1.0 comme revue groupée gouvernée. Les 22/22 valeurs restent qualifiées ainsi : 9 dans leur seule portée synthétique, 8 partielles et 5 ouvertes ; preuves attendues acceptées : 0/13. Aucune valeur de production n’est désignée ; 0/6 condition G1 est clôturable, G1 reste ouverte et L2 fermé. Zéro nouveau droit, fiche active, entrée réelle, import, connecteur, automatisme, titulaire réel, mandat nominatif, délégation, accès C3/C4/C5, migration de production, restauration réelle, référence GED créée, worker ou alerte ; décisions sur le lot : 77 ; sources maîtresses désignées : 0 ; changements en production : 0.',
    source: 'Supports contrôlés : décisions REF-01-DEC-001 à REF-01-DEC-080, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, moteur et tests synthétiques du pilote, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, migrations SQL montante et descendante, scripts/validateRef01Migrations.mjs et recherche interne bornée du 01-09-2026 ; sources officielles PFPDT Suisse, CDP Sénégal et OHADA.'
  },
  EN: {
    eyebrow: 'CANDIDATE-SUPPORT CONTROL · REF-01 · V1.83 · 1 SEP 2026',
    ...
    nextControl: 'Have REF-01-G1-COL-004 V0.1 confirmed or amended as the grouped report of the bounded internal search. Keep every requalification pending admissible production evidence; launch no external contact, real package or L2.',
    boundary: 'Status: REF-01-DEC-080 confirms REV-006 V1.0 as the governed grouped review. All 22/22 values retain their qualification: 9 within synthetic scope only, 8 partial and 5 open; accepted expected proofs: 0/13. No production value is designated; 0/6 G1 conditions are closable, G1 remains open and L2 closed. Zero new rights, active records, real entries, imports, connectors, automations, real holders, named mandates, delegations, C3/C4/C5 access, production migrations, real restores, created DMS references, workers or alerts; package decisions: 77; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: decisions REF-01-DEC-001 through REF-01-DEC-080, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetic pilot engine and tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, up and down SQL migrations, scripts/validateRef01Migrations.mjs and the bounded internal search of 1 Sep 2026; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.83 · 01.09.2026',
    ...
    nextControl: 'REF-01-G1-COL-004 V0.1 als gebündeltes Protokoll der begrenzten internen Suche bestätigen oder ändern lassen. Jede Neueinstufung bis zu einem zulässigen Produktivnachweis aussetzen; keinen externen Kontakt, kein reales Los und kein L2 starten.',
    boundary: 'Stand: REF-01-DEC-080 bestätigt REV-006 V1.0 als gesteuerte gebündelte Prüfung. Alle 22/22 Werte behalten ihre Qualifizierung: 9 nur in synthetischem Umfang, 8 teilweise und 5 offen; angenommene erwartete Nachweise: 0/13. Kein Produktionswert ist bestimmt; 0/6 G1-Bedingungen sind schliessbar, G1 bleibt offen und L2 geschlossen. Null neue Rechte, aktive Einträge, reale Eingänge, Importe, Connectoren, Automatismen, reale Inhaber, Namensmandate, Delegationen, C3/C4/C5-Zugriffe, Produktivmigrationen, reale Wiederherstellungen, erstellte DMS-Referenzen, Worker oder Alarme; Paketentscheide: 77; bestimmte Masterquellen: 0; produktive Änderungen: 0.',
    source: 'Kontrollierte Träger: REF-01-DEC-001 bis REF-01-DEC-080, PLN-002 V1.0, FTK-001 V1.0, QLF-001 V1.0, ARB-002 V1.0, COL-003 V1.1, COL-INV-001 V1.0, REV-006 V1.0, COL-004 V0.1, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, PGM-CPK-001 V0.1, M3S-INB-001 V1.0, M3S-INB-002 V1.0, M3S-INB-003 V1.1, synthetisches Pilotmodul und Tests, docs/REF-01-L1-DATA-FOUNDATIONS.md, migrations/ref01/README.md, SQL-Up- und Down-Migrationen, scripts/validateRef01Migrations.mjs sowie die begrenzte interne Suche vom 01.09.2026; amtliche Quellen EDOEB Schweiz, CDP Senegal und OHADA.'
  }
};
