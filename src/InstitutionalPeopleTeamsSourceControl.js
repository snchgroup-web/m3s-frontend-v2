...
const COPY = {
  FR: {
    eyebrow: 'CONTROLE DES SUPPORTS CANDIDATS · REF-01 · V1.64 · 29-08-2026',
  ...
  EN: {
    ...
    nextControl: 'Confirm or amend REF-01-G1-AUT-02-01-001 V0.1, the first individual PostgreSQL and restoration structure.',
    boundary: 'Status: REF-01-DEC-061 confirms WAV-003 V1.0 and opens three separate documentary preparations. AUT-02-01-001 V0.1 structures eleven fields without opening an environment or test; G1 remains open and L2 closed. Zero new rights, active records, real holders, named mandates, delegations, exceptions, C3/C4/C5 access, workers, alerts, replays or providers; package decisions: 58; designated master sources: 0; production changes: 0.',
    source: 'Controlled supports: isolated L1 candidate RH-001 API contract, synthetic C2 fixture and local handler tests, C2 Internal Directory, Team/Agent, DMS framing, decisions REF-01-DEC-001 through REF-01-DEC-061, AUT-02-03-002/AUT-02-02-002 V1.0 matrices, AUT-02-03-003 V1.0 LEGAL framework, AUT-02-03-004 V1.0 designation, AUT-02-03-005 V1.0 ownership/triggers, AUT-02-03-006 V1.0 review protocols, AUT-02-03-007 V1.0 empty register, AUT-02-03-008 V1.0 gates, AUT-02-03-009 V1.0 decision sheet, AUT-02-03-010 V1.0 protocol, AUT-02-03-011 V1.0 GO/NO-GO sheet, AUT-02-02-003 V1.0 Roles and least privilege model, AUT-02-02-004 V1.0 Tested rights and denials matrix, AUT-02-02-005 V1.0 Grant and withdrawal protocol, AUT-02-02-006 V1.0 access-rights register, AUT-02-02-007 V1.0 opening gates, AUT-02-02-008 V1.0 decision sheet, AUT-02-02-009 V1.0 protocol, AUT-02-02-010 V1.0 GO/NO-GO sheet, REV-004 V1.0 reassessment, WAV-003 V1.0 and AUT-02-01-001 V0.1 candidate; official Swiss FDPIC, Senegal CDP and OHADA sources.'
  },
  DE: {
    eyebrow: 'KONTROLLE DER QUELLKANDIDATEN · REF-01 · V1.64 · 29.08.2026',
