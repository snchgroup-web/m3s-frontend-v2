...
const COPY = {
  FR: {
    ...
    decision: 'REQ-002 V1.0 gouverne le modèle de demande, pas son émission. DEC-071 confirme désormais NAM-002 V1.0 comme cinq emplacements vides, sans nommer ni contacter personne.',
  ...
  EN: {
    ...
    decision: 'REQ-002 V1.0 governs the request template, not its release. DEC-071 now confirms NAM-002 V1.0 as five empty slots, without naming or contacting anyone.',
  ...
  DE: {
    ...
    decision: 'REQ-002 V1.0 steuert die Anfragevorlage, nicht den Versand. DEC-071 bestätigt nun NAM-002 V1.0 als fünf leere Stellen, ohne jemanden zu benennen oder zu kontaktieren.',
