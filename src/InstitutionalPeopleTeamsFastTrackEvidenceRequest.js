...
const COPY = {
  FR: {
    ...
    decision: 'REQ-002 V1.0 gouverne le modèle de demande, pas son émission. DEC-070 confirme désormais REC-002 V1.0 comme cinq profils fonctionnels sans nommer personne.',
  ...
  EN: {
    ...
    decision: 'REQ-002 V1.0 governs the request template, not its release. DEC-070 now confirms REC-002 V1.0 as five functional profiles without naming anyone.',
  ...
  DE: {
    ...
    decision: 'REQ-002 V1.0 steuert die Anfragevorlage, nicht den Versand. DEC-070 bestätigt nun REC-002 V1.0 als fünf Funktionsprofile, ohne jemanden zu benennen.',
