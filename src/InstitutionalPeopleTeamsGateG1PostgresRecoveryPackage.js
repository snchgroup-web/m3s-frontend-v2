...
const COPY = {
  FR: {
    eyebrow: 'SUPPORT CANDIDAT · LOT 3 · REF-01-G1-PKG-03-001 · V0.1 · 27-08-2026',
    title: 'Préparer la comparaison PostgreSQL et reprise sans choisir de service',
    intro: 'Ce dossier transforme PKG-03 en grille de décision documentaire. Il définit les questions et preuves attendues sans nommer de fournisseur, fixer de cible technique ni lancer de sauvegarde ou de restauration.',
    counters: [['Dossier candidat', '1', 'PKG-03-001 V0.1'], ['Axes contrôlés', '4', 'Décision documentaire'], ['Services retenus', '0', 'Aucun choix'], ['Actions réelles', '0', 'Aucun test ni compte']],
    ...
    status: 'CANDIDAT · Un dossier documentaire préparé ; zéro fournisseur, zéro prix, zéro compte, zéro secret, zéro sauvegarde et zéro restauration réelle.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-PKG-03-001 V0.1. Une confirmation validera seulement la grille documentaire.',
  ...
  EN: {
    eyebrow: 'CANDIDATE SUPPORT · PACKAGE 3 · REF-01-G1-PKG-03-001 · V0.1 · 27 AUG 2026',
    title: 'Prepare the PostgreSQL and recovery comparison without selecting a service',
    intro: 'This file turns PKG-03 into a documentary decision grid. It defines questions and expected evidence without naming a provider, setting a technical target or starting backup or restoration.',
    counters: [['Candidate file', '1', 'PKG-03-001 V0.1'], ['Controlled areas', '4', 'Documentary decision'], ['Selected services', '0', 'No choice'], ['Real actions', '0', 'No test or account']],
    ...
    status: 'CANDIDATE · One documentary file prepared; zero providers, prices, accounts, secrets, real backups or restorations.',
    next: 'Next human decision: confirm or amend REF-01-G1-PKG-03-001 V0.1. Confirmation will validate only the documentary grid.',
  ...
  DE: {
    eyebrow: 'KANDIDATENTRÄGER · PAKET 3 · REF-01-G1-PKG-03-001 · V0.1 · 27.08.2026',
    title: 'Den PostgreSQL- und Wiederanlaufvergleich ohne Dienstwahl vorbereiten',
    intro: 'Diese Akte überführt PKG-03 in ein dokumentarisches Entscheidungsraster. Sie definiert Fragen und erwartete Nachweise, ohne Anbieter zu nennen, ein technisches Ziel festzulegen oder Sicherung und Wiederherstellung zu starten.',
    counters: [['Kandidatenakte', '1', 'PKG-03-001 V0.1'], ['Kontrollbereiche', '4', 'Dokumentarischer Entscheid'], ['Gewählte Dienste', '0', 'Keine Wahl'], ['Reale Aktionen', '0', 'Kein Test, kein Konto']],
    ...
    status: 'KANDIDAT · Eine Dokumentakte vorbereitet; null Anbieter, Preise, Konten, Geheimnisse, reale Sicherungen oder Wiederherstellungen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-PKG-03-001 V0.1 bestätigen oder ändern. Eine Bestätigung validiert nur das Dokumentraster.',
