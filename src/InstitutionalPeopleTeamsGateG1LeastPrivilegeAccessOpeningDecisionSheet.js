...
const COPY = {
  FR: {
    eyebrow: 'FICHE DE DECISION D OUVERTURE D UNE HABILITATION · CANDIDAT V0.1 · 29-08-2026',
    ...
    status: 'CANDIDAT · Gabarit documentaire V0.1. Zéro fiche active, signature réelle, titulaire, compte, droit, accès ou exécution.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-02-008 V0.1.',
  ...
  EN: {
    eyebrow: 'ACCESS-OPENING DECISION SHEET · V0.1 CANDIDATE · 29 AUG 2026',
    ...
    status: 'CANDIDATE · V0.1 documentary template. Zero active records, real signatures, holders, accounts, rights, access or executions.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-02-008 V0.1.',
  ...
  DE: {
    eyebrow: 'ENTSCHEIDBLATT ZUR BERECHTIGUNGSEROEFFNUNG · KANDIDAT V0.1 · 29.08.2026',
    ...
    status: 'KANDIDAT · Dokumentationsvorlage V0.1. Null aktive Einträge, reale Unterschriften, Inhaber, Konten, Rechte, Zugriffe oder Ausführungen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-02-008 V0.1 bestätigen oder ändern.',
