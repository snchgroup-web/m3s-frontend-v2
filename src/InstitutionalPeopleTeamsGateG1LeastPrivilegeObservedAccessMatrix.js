...
const COPY = {
  FR: {
    ...
    status: 'CANDIDAT · Matrice de qualification du contrat L1 et de ses tests synthétiques. Zéro compte, attribution, retrait, délégation, exception, accès C3/C4/C5 ou modification de production.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-02-004 V0.2.',
  ...
  EN: {
    ...
    status: 'CANDIDATE · Qualification matrix for the L1 contract and its synthetic tests. Zero account, assignment, withdrawal, delegation, exception, C3/C4/C5 access or production change.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-02-004 V0.2.',
  ...
  DE: {
    ...
    status: 'KANDIDAT · Qualifikationsmatrix für den L1-Vertrag und seine synthetischen Tests. Null Konten, Zuweisungen, Entzüge, Delegationen, Ausnahmen, C3/C4/C5-Zugriffe oder Produktionsänderungen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-02-004 V0.2 bestätigen oder ändern.',
