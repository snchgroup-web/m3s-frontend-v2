...
const COPY = {
  FR: {
    ...
    next: 'DEC-068 à DEC-076 confirment les cadres COL-003 à M3S-INB-001 et enregistrent dans M3S-INB-003 V1.1 le GO limité aux six cas synthétiques M3S-INB-002. Les 6/6 cas sont exécutés ; aucun traitement réel, contact, infrastructure ni L2 n’est ouvert.',
  ...
  EN: {
    ...
    next: 'DEC-068 through DEC-076 confirm the COL-003 through M3S-INB-001 frameworks and record in M3S-INB-003 V1.1 the limited GO for six synthetic M3S-INB-002 cases. All 6/6 cases were run; no real-data processing, contact, infrastructure or L2 is open.',
  ...
  DE: {
    ...
    next: 'DEC-068 bis DEC-076 bestätigen die Rahmen COL-003 bis M3S-INB-001 und erfassen in M3S-INB-003 V1.1 das begrenzte GO für sechs synthetische M3S-INB-002-Fälle. Alle 6/6 Fälle wurden ausgeführt; keine reale Verarbeitung, kein Kontakt, keine Infrastruktur und kein L2 sind geöffnet.',
