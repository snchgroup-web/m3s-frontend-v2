...
const COPY = {
  FR: {
    ...
    next: 'DEC-068 à DEC-072 confirment COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0 et AUT-003 V1.0. M3S-INB-001 V0.1 est le prochain candidat groupé, en lecture seule ; aucun import, traitement réel, contact, infrastructure ni action L2 n’est ouvert.',
  ...
  EN: {
    ...
    next: 'DEC-068 through DEC-072 confirm COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0 and AUT-003 V1.0. M3S-INB-001 V0.1 is the next grouped read-only candidate; no import, real-data processing, contact, infrastructure or L2 action is opened.',
  ...
  DE: {
    ...
    next: 'DEC-068 bis DEC-072 bestätigen COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0 und AUT-003 V1.0. M3S-INB-001 V0.1 ist der nächste gebündelte, schreibgeschützte Kandidat; kein Import, keine Verarbeitung realer Daten, kein Kontakt, keine Infrastruktur oder L2-Aktion wird geöffnet.',
