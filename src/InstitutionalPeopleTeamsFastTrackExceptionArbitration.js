...
const COPY = {
  FR: {
    ...
    next: 'DEC-068 à DEC-071 confirment COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0 et NAM-002 V1.0. AUT-003 V0.1 est le prochain candidat groupé ; aucune identité, autorisation, prise de contact, collecte sensible, connexion, infrastructure ni action L2 n’est ouverte.',
  ...
  EN: {
    ...
    next: 'DEC-068 through DEC-071 confirm COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0 and NAM-002 V1.0. AUT-003 V0.1 is the next grouped candidate; no identity, authorisation, contact, sensitive collection, connection, infrastructure or L2 action is opened.',
  ...
  DE: {
    ...
    next: 'DEC-068 bis DEC-071 bestätigen COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0 und NAM-002 V1.0. AUT-003 V0.1 ist der nächste gebündelte Kandidat; keine Identität, Autorisierung, Kontaktaufnahme, sensible Sammlung, Verbindung, Infrastruktur oder L2-Aktion wird geöffnet.',
