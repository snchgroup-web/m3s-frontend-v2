...
const COPY = {
  FR: {
    ...
    next: 'DEC-068 à DEC-074 confirment COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0 et le protocole M3S-INB-002 V1.0. Le prochain candidat est une fiche GO/NO-GO vide ; aucun cas, import, traitement réel, contact, infrastructure ni action L2 n’est ouvert.',
  ...
  EN: {
    ...
    next: 'DEC-068 through DEC-074 confirm COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0 and the M3S-INB-002 V1.0 protocol. The next candidate is an empty GO/NO-GO form; no case, import, real-data processing, contact, infrastructure or L2 action is opened.',
  ...
  DE: {
    ...
    next: 'DEC-068 bis DEC-074 bestätigen COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0 und das Protokoll M3S-INB-002 V1.0. Der nächste Kandidat ist ein leeres GO/NO-GO-Blatt; kein Fall, Import, keine Verarbeitung realer Daten, kein Kontakt, keine Infrastruktur oder L2-Aktion wird geöffnet.',
