...
const COPY = {
  FR: {
    ...
    next: 'Étape candidate : REF-01-G1-COL-003 V0.1 regroupe la préparation des preuves des cinq familles. Sa confirmation n’autorisera encore aucune collecte sensible, connexion, création d’infrastructure ni action L2.',
  ...
  EN: {
    ...
    next: 'Candidate next step: REF-01-G1-COL-003 V0.1 groups evidence preparation for all five families. Confirming it would still authorise no sensitive collection, connection, infrastructure creation or L2 action.',
  ...
  DE: {
    ...
    next: 'Nächster Kandidat: REF-01-G1-COL-003 V0.1 bündelt die Nachweisvorbereitung der fünf Familien. Seine Bestätigung erlaubt weiterhin keine sensible Sammlung, Verbindung, Infrastrukturerstellung oder L2-Aktion.',
