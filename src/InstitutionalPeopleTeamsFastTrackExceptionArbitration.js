...
const COPY = {
  FR: {
    ...
    next: 'Étape confirmée par DEC-068 : COL-003 V1.0 gouverne le plan documentaire des cinq dossiers. REQ-002 V0.1 est le prochain candidat groupé ; aucun envoi, collecte sensible, connexion, infrastructure ni action L2 n’est autorisé.',
  ...
  EN: {
    ...
    next: 'Step confirmed through DEC-068: COL-003 V1.0 governs the documentary plan for the five files. REQ-002 V0.1 is the next grouped candidate; no release, sensitive collection, connection, infrastructure or L2 action is authorised.',
  ...
  DE: {
    ...
    next: 'Mit DEC-068 bestätigter Schritt: COL-003 V1.0 steuert den Dokumentationsplan der fünf Akten. REQ-002 V0.1 ist der nächste gebündelte Kandidat; kein Versand, keine sensible Sammlung, Verbindung, Infrastruktur oder L2-Aktion ist erlaubt.',
