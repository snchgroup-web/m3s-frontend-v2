...
const COPY = {
  FR: {
    ...
    next: 'DEC-068 à DEC-075 confirment COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0, le protocole M3S-INB-002 V1.0 et la fiche vide M3S-INB-003 V1.0. Aucun GO, cas, import, traitement réel, contact, infrastructure ni action L2 n’est ouvert.',
  ...
  EN: {
    ...
    next: 'DEC-068 through DEC-075 confirm COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0, the M3S-INB-002 V1.0 protocol and the empty M3S-INB-003 V1.0 form. No GO, case, import, real-data processing, contact, infrastructure or L2 action is opened.',
  ...
  DE: {
    ...
    next: 'DEC-068 bis DEC-075 bestätigen COL-003 V1.0, REQ-002 V1.0, REC-002 V1.0, NAM-002 V1.0, AUT-003 V1.0, M3S-INB-001 V1.0, das Protokoll M3S-INB-002 V1.0 und das leere Blatt M3S-INB-003 V1.0. Kein GO, Fall, Import, keine Verarbeitung realer Daten, kein Kontakt, keine Infrastruktur oder L2-Aktion wird geöffnet.',
