...
const COPY = {
  FR: {
    ...
    next: 'Étapes confirmées par DEC-068 et DEC-069 : COL-003 V1.0 gouverne les cinq dossiers et REQ-002 V1.0 leur modèle unique sans envoi. REC-002 V0.1 est le prochain candidat groupé ; aucune identité, aucun contact, envoi, collecte sensible, connexion, infrastructure ni action L2 n’est autorisé.',
  ...
  EN: {
    ...
    next: 'Steps confirmed through DEC-068 and DEC-069: COL-003 V1.0 governs the five files and REQ-002 V1.0 their single template without release. REC-002 V0.1 is the next grouped candidate; no identity, contact, release, sensitive collection, connection, infrastructure or L2 action is authorised.',
  ...
  DE: {
    ...
    next: 'Mit DEC-068 und DEC-069 bestätigte Schritte: COL-003 V1.0 steuert die fünf Akten und REQ-002 V1.0 ihre einheitliche Vorlage ohne Versand. REC-002 V0.1 ist der nächste gebündelte Kandidat; keine Identität, kein Kontakt, Versand, keine sensible Sammlung, Verbindung, Infrastruktur oder L2-Aktion ist erlaubt.',
