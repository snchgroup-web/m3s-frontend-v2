...
import InstitutionalPeopleTeamsAutBatchConfirmation from './InstitutionalPeopleTeamsAutBatchConfirmation';
import InstitutionalPeopleTeamsAutWaveOneCandidate from './InstitutionalPeopleTeamsAutWaveOneCandidate';
import InstitutionalPeopleTeamsAutWaveOneConfirmation from './InstitutionalPeopleTeamsAutWaveOneConfirmation';
import InstitutionalPeopleTeamsAutWaveOneResults from './InstitutionalPeopleTeamsAutWaveOneResults';
import InstitutionalPeopleTeamsAutWaveOneResultsConfirmation from './InstitutionalPeopleTeamsAutWaveOneResultsConfirmation';
import InstitutionalPeopleTeamsAutCorrectedScopesCandidate from './InstitutionalPeopleTeamsAutCorrectedScopesCandidate';
import InstitutionalPeopleTeamsAutCorrectedScopesConfirmation from './InstitutionalPeopleTeamsAutCorrectedScopesConfirmation';
import InstitutionalPeopleTeamsAutDocumentaryFiles from './InstitutionalPeopleTeamsAutDocumentaryFiles';
import InstitutionalPeopleTeamsAutDocumentaryFilesConfirmation from './InstitutionalPeopleTeamsAutDocumentaryFilesConfirmation';
...
import InstitutionalPeopleTeamsGateG1PackageRegisterConfirmation from './InstitutionalPeopleTeamsGateG1PackageRegisterConfirmation';
import InstitutionalPeopleTeamsGateG1PriorityOnePackages from './InstitutionalPeopleTeamsGateG1PriorityOnePackages';
import InstitutionalPeopleTeamsGateG1PriorityOneConfirmation from './InstitutionalPeopleTeamsGateG1PriorityOneConfirmation';
import InstitutionalPeopleTeamsGateG1PostgresRecoveryPackage from './InstitutionalPeopleTeamsGateG1PostgresRecoveryPackage';
import InstitutionalPeopleTeamsGateG1PostgresRecoveryConfirmation from './InstitutionalPeopleTeamsGateG1PostgresRecoveryConfirmation';
import InstitutionalPeopleTeamsGateG1MigrationRollbackPackage from './InstitutionalPeopleTeamsGateG1MigrationRollbackPackage';
import InstitutionalPeopleTeamsGateG1MigrationRollbackConfirmation from './InstitutionalPeopleTeamsGateG1MigrationRollbackConfirmation';
import InstitutionalPeopleTeamsGateG1OutboxMonitoringPackage from './InstitutionalPeopleTeamsGateG1OutboxMonitoringPackage';
import InstitutionalPeopleTeamsGateG1OutboxMonitoringConfirmation from './InstitutionalPeopleTeamsGateG1OutboxMonitoringConfirmation';
import InstitutionalPeopleTeamsGateG1FinalPackageReview from './InstitutionalPeopleTeamsGateG1FinalPackageReview';
import InstitutionalPeopleTeamsGateG1FinalReviewConfirmation from './InstitutionalPeopleTeamsGateG1FinalReviewConfirmation';
import InstitutionalPeopleTeamsGateG1ExitEvidenceRegister from './InstitutionalPeopleTeamsGateG1ExitEvidenceRegister';
import InstitutionalPeopleTeamsGateG1ExitEvidenceConfirmation from './InstitutionalPeopleTeamsGateG1ExitEvidenceConfirmation';
...
import InstitutionalPeopleTeamsGateG1DocumentaryAuthorisationFilesConfirmation from './InstitutionalPeopleTeamsGateG1DocumentaryAuthorisationFilesConfirmation';
import InstitutionalPeopleTeamsGateG1ElevenFieldCandidateMatrices from './InstitutionalPeopleTeamsGateG1ElevenFieldCandidateMatrices';
...
const InstitutionalDataReferenceSystemsConsolidationPilot = ({ language = 'FR', onNavigate }) => {
  ...
  return (
    <section id={sectionId} className="m3s-panel scroll-mt-24 p-4 sm:p-5" aria-labelledby={`${sectionId}-title`}>
      ...
      <InstitutionalReferenceCodeLegend language={language} />
      ...
      <InstitutionalPeopleTeamsAutBatchConfirmation language={language} />
      <InstitutionalPeopleTeamsAutWaveOneCandidate language={language} />
      <InstitutionalPeopleTeamsAutWaveOneConfirmation language={language} />
      <InstitutionalPeopleTeamsAutWaveOneResults language={language} />
      <InstitutionalPeopleTeamsAutWaveOneResultsConfirmation language={language} />
      <InstitutionalPeopleTeamsAutCorrectedScopesCandidate language={language} />
      <InstitutionalPeopleTeamsAutCorrectedScopesConfirmation language={language} />
      <InstitutionalPeopleTeamsAutDocumentaryFiles language={language} />
      <InstitutionalPeopleTeamsAutDocumentaryFilesConfirmation language={language} />
      ...
      <InstitutionalPeopleTeamsGateG1PackageRegisterConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1PriorityOnePackages language={language} />
      <InstitutionalPeopleTeamsGateG1PriorityOneConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1PostgresRecoveryPackage language={language} />
      <InstitutionalPeopleTeamsGateG1PostgresRecoveryConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1MigrationRollbackPackage language={language} />
      <InstitutionalPeopleTeamsGateG1MigrationRollbackConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1OutboxMonitoringPackage language={language} />
      <InstitutionalPeopleTeamsGateG1OutboxMonitoringConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1FinalPackageReview language={language} />
      <InstitutionalPeopleTeamsGateG1FinalReviewConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1ExitEvidenceRegister language={language} />
      <InstitutionalPeopleTeamsGateG1ExitEvidenceConfirmation language={language} />
      ...
      <InstitutionalPeopleTeamsGateG1DocumentaryAuthorisationFilesConfirmation language={language} />
      <InstitutionalPeopleTeamsGateG1ElevenFieldCandidateMatrices language={language} />
