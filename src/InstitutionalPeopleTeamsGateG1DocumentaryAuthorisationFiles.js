...
const COPY = {
  FR: {
    eyebrow: 'FICHES CONFIRMÉES · VAGUE 1 DOCUMENTAIRE · 28-08-2026',
    ...
    counters: [['Fiches confirmées', '2/2', 'Cadres V1.0'], ['Champs restant ouverts', '11', 'Cinq + six'], ['Actions réelles', '0', 'Lecture gouvernée seulement'], ['Clauses confirmées', '2', 'Portées séparées']],
    badge: 'CONFIRMÉ · NON AUTORISÉ',
  ...
  EN: {
    eyebrow: 'CONFIRMED FILES · DOCUMENTARY WAVE 1 · 28 AUG 2026',
    ...
    counters: [['Confirmed files', '2/2', 'V1.0 frameworks'], ['Fields still open', '11', 'Five + six'], ['Real actions', '0', 'Governed reading only'], ['Confirmed clauses', '2', 'Separate scopes']],
    badge: 'CONFIRMED · NOT AUTHORISED',
  ...
  DE: {
    eyebrow: 'BESTÄTIGTE AKTEN · DOKUMENTARISCHE WELLE 1 · 28.08.2026',
    ...
    counters: [['Bestätigte Akten', '2/2', 'Rahmen V1.0'], ['Weiter offene Felder', '11', 'Fünf + sechs'], ['Reale Aktionen', '0', 'Nur gesteuerte Lektüre'], ['Bestätigte Klauseln', '2', 'Getrennte Umfänge']],
    badge: 'BESTÄTIGT · NICHT AUTORISIERT',
