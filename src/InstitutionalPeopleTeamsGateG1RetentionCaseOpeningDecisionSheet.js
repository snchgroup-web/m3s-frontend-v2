...
const COPY = {
  FR: {
    eyebrow: 'FICHE DE DECISION D OUVERTURE · CANDIDAT V0.1 · 28-08-2026',
    ...
    rulesTitle: 'Quatre règles de complétude proposées',
    rules: ['Six portes renseignées', 'Un seul verdict retenu', 'Autorité et mandat contrôlés', 'Aucune donnée C3/C4 dans REF-01'],
    status: 'CANDIDAT · Gabarit vide préparé. Zéro formulaire actif, signature, cas réel, accès ou opération GED.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-03-009 V0.1.',
    boundary: 'Une confirmation validera uniquement la structure documentaire. Toute première utilisation réelle exigera une autorisation séparée, un espace protégé et le contrôle du cas concerné.'
  },
  EN: {
    eyebrow: 'CASE-OPENING DECISION SHEET · V0.1 CANDIDATE · 28 AUG 2026',
    ...
    rulesTitle: 'Four proposed completion rules',
    rules: ['Six gates recorded', 'One outcome only', 'Authority and mandate checked', 'No C3/C4 data in REF-01'],
    status: 'CANDIDATE · Empty template prepared. Zero active forms, signatures, real cases, access or DMS operations.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-03-009 V0.1.',
    boundary: 'Confirmation will validate only the documentary structure. Any first real use will require separate authorisation, a protected space and review of the relevant case.'
  },
  DE: {
    eyebrow: 'ENTSCHEIDBLATT ZUR FALLERÖFFNUNG · KANDIDAT V0.1 · 28.08.2026',
    ...
    rulesTitle: 'Vier vorgeschlagene Vollständigkeitsregeln',
    rules: ['Sechs Tore dokumentiert', 'Nur ein Ergebnis gewählt', 'Autorität und Mandat geprüft', 'Keine C3/C4-Daten in REF-01'],
    status: 'KANDIDAT · Leere Vorlage vorbereitet. Null aktive Formulare, Unterschriften, reale Fälle, Zugriffe oder DMS-Operationen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-03-009 V0.1 bestätigen oder ändern.',
    boundary: 'Eine Bestätigung validiert nur die Dokumentationsstruktur. Jede erste reale Nutzung erfordert eine getrennte Autorisierung, einen geschützten Raum und die Prüfung des betreffenden Falls.'
  }
};
