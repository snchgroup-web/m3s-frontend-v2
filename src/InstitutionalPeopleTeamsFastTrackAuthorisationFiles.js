...
const COPY = {
  FR: {
    eyebrow: 'DOSSIERS D’AUTORISATION CANDIDATS · REF-01-G1-AUT-003 · V0.1 · 30-08-2026',
    title: 'Préparer cinq autorisations vides sans ouvrir l’exécution',
    intro: 'AUT-003 transforme chaque emplacement NAM-EXC confirmé en dossier de contrôle distinct. Les cinq dossiers restent vides : ils ne contiennent ni identité, ni autorité vérifiée, ni canal, ni décision exécutoire.',
    ...
    decision: 'Confirmer : « Je confirme REF-01-G1-AUT-003 V0.1 comme cadre des cinq dossiers d’autorisation vides, sans autoriser ni contacter personne. » Amender : indiquer uniquement le dossier AUT-EXC concerné.',
  ...
  EN: {
    eyebrow: 'CANDIDATE AUTHORISATION FILES · REF-01-G1-AUT-003 · V0.1 · 30 AUG 2026',
    title: 'Prepare five empty authorisations without opening execution',
    intro: 'AUT-003 turns each confirmed NAM-EXC slot into a separate control file. All five files remain empty: they contain no identity, verified authority, channel or executable decision.',
    ...
    decision: 'Confirm: “I confirm REF-01-G1-AUT-003 V0.1 as the framework for the five empty authorisation files, without authorising or contacting anyone.” Amend: identify only the affected AUT-EXC file.',
  ...
  DE: {
    eyebrow: 'KANDIDATEN FÜR AUTORISIERUNGSAKTEN · REF-01-G1-AUT-003 · V0.1 · 30.08.2026',
    title: 'Fünf leere Autorisierungen ohne Ausführungsöffnung vorbereiten',
    intro: 'AUT-003 überführt jede bestätigte NAM-EXC-Stelle in eine getrennte Kontrollakte. Alle fünf Akten bleiben leer: Sie enthalten keine Identität, geprüfte Befugnis, keinen Kanal und keinen ausführbaren Entscheid.',
    ...
    decision: 'Bestätigen: „Ich bestätige REF-01-G1-AUT-003 V0.1 als Rahmen der fünf leeren Autorisierungsakten, ohne jemanden zu autorisieren oder zu kontaktieren.“ Ändern: Nur die betroffene AUT-EXC-Akte nennen.',
