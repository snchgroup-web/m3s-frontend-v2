...
const COPY = {
  FR: {
    eyebrow: 'REGISTRE CANDIDAT D’AUTORISATION NOMINATIVE · REF-01-G1-AUT-001 · V0.1 · 26-08-2026',
    title: 'Autoriser chaque future inscription séparément',
    intro: 'Ce registre applique NAM-001 V1.0 en préparant quatre dossiers d’autorisation vides. Une décision sur un dossier ne s’étend jamais aux autres et ne vaut pas autorisation d’envoi.',
    ...
    labels: { scope: 'Portée du dossier', requirements: 'Éléments requis', status: 'DOSSIER VIDE · NON AUTORISÉ' },
    records: [
    ...
    next: 'Prochain arbitrage humain : confirmer ou amender AUT-001 V0.1. Après confirmation seulement, chaque identité réelle devra faire l’objet d’une fiche et d’une décision distinctes.',
    boundary: 'Limite : AUT-001 ne contient aucune identité et n’autorise aucun contact, envoi, compte, essai, achat, fournisseur, preuve réelle, fermeture de G1 ou ouverture de L2.'
  },
  EN: {
    eyebrow: 'CANDIDATE NAMED-RECORD AUTHORISATION REGISTER · REF-01-G1-AUT-001 · V0.1 · 26 AUG 2026',
    title: 'Authorise each future entry separately',
    intro: 'This register applies NAM-001 V1.0 by preparing four empty authorisation files. A decision on one file never extends to another and does not authorise a send.',
    ...
    labels: { scope: 'File scope', requirements: 'Required elements', status: 'EMPTY FILE · NOT AUTHORISED' },
    records: [
    ...
    next: 'Next human decision: confirm or amend AUT-001 V0.1. Only after confirmation must every real identity receive its own record and separate decision.',
    boundary: 'Boundary: AUT-001 contains no identity and authorises no contact, send, account, trial, purchase, provider, real evidence, G1 closure or L2 opening.'
  },
  DE: {
    eyebrow: 'KANDIDATENREGISTER FÜR NAMENSAUTORISIERUNGEN · REF-01-G1-AUT-001 · V0.1 · 26.08.2026',
    title: 'Jeden künftigen Eintrag getrennt autorisieren',
    intro: 'Dieses Register wendet NAM-001 V1.0 an und bereitet vier leere Autorisierungsdossiers vor. Ein Entscheid für ein Dossier gilt nie für ein anderes und autorisiert keinen Versand.',
    ...
    labels: { scope: 'Umfang des Dossiers', requirements: 'Erforderliche Elemente', status: 'LEERES DOSSIER · NICHT AUTORISIERT' },
    records: [
    ...
    next: 'Nächster menschlicher Entscheid: AUT-001 V0.1 bestätigen oder ändern. Erst danach braucht jede reale Identität ein eigenes Blatt und einen getrennten Entscheid.',
    boundary: 'Grenze: AUT-001 enthält keine Identität und autorisiert weder Kontakt, Versand, Account, Test, Kauf, Anbieter, reale Nachweise, G1-Schliessung noch L2-Öffnung.'
  }
};
