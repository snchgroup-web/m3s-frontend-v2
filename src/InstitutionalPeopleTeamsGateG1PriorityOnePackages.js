...
const COPY = {
  FR: {
    eyebrow: 'SUPPORTS CONFIRMÉS · PRIORITÉ 1 · 27-08-2026',
    title: 'Deux matrices gouvernées sans accès ni opération sur les pièces',
    intro: 'Les deux matrices confirmées traduisent PKG-001 V1.0 en contrôles documentaires. Elles nomment des fonctions, des axes et des livrables, jamais des personnes, droits ou durées de conservation réels.',
    counters: [['Supports confirmés', '2', 'PKG-01 et PKG-02 V1.0'], ['Responsables nommés', '0', 'Fonctions seulement'], ['Changements réels', '0', 'Aucun accès ni pièce'], ['Autorisations L2', '0', 'L2 reste fermé']],
    badge: 'CONFIRMÉ',
    ...
    packages: [
      {
        id: 'REF-01-G1-PKG-01-001', version: 'V1.0', title: 'Rôles et visibilité', icon: KeyRound,
      ...
      {
        id: 'REF-01-G1-PKG-02-001', version: 'V1.0', title: 'Conservation et GED', icon: Archive,
    ...
    status: 'CONFIRMÉS · Deux supports gouvernés, zéro titulaire, zéro accès, zéro durée inventée et zéro pièce modifiée.',
    next: 'Décision consignée ci-dessous : REF-01-DEC-030 confirme ensemble PKG-01-001 V1.0 et PKG-02-001 V1.0.',
    boundary: 'La confirmation des matrices ne donne aucun droit et ne permet aucune opération sur une pièce réelle.'
  },
  EN: {
    eyebrow: 'CONFIRMED SUPPORTS · PRIORITY 1 · 27 AUG 2026',
    title: 'Two governed matrices without access or record operations',
    intro: 'Both confirmed matrices translate PKG-001 V1.0 into documentary controls. They name functions, axes and outputs, never real people, rights or retention periods.',
    counters: [['Confirmed supports', '2', 'PKG-01 and PKG-02 V1.0'], ['Named owners', '0', 'Functions only'], ['Real changes', '0', 'No access or records'], ['L2 authorisations', '0', 'L2 remains closed']],
    badge: 'CONFIRMED',
    ...
    packages: [
      {
        id: 'REF-01-G1-PKG-01-001', version: 'V1.0', title: 'Roles and visibility', icon: KeyRound,
      ...
      {
        id: 'REF-01-G1-PKG-02-001', version: 'V1.0', title: 'Retention and DMS', icon: Archive,
    ...
    status: 'CONFIRMED · Two governed supports, zero holders, zero access, zero invented periods and zero changed records.',
    next: 'Decision recorded below: REF-01-DEC-030 confirms PKG-01-001 V1.0 and PKG-02-001 V1.0 together.',
    boundary: 'Confirmation of the matrices grants no right and permits no operation on a real record.'
  },
  DE: {
    eyebrow: 'BESTÄTIGTE TRÄGER · PRIORITÄT 1 · 27.08.2026',
    title: 'Zwei gesteuerte Matrizen ohne Zugriff oder Unterlagenoperation',
    intro: 'Beide bestätigten Matrizen übersetzen PKG-001 V1.0 in dokumentarische Kontrollen. Sie nennen Funktionen, Achsen und Ergebnisse, niemals reale Personen, Rechte oder Aufbewahrungsfristen.',
    counters: [['Bestätigte Träger', '2', 'PKG-01 und PKG-02 V1.0'], ['Benannte Verantwortliche', '0', 'Nur Funktionen'], ['Reale Änderungen', '0', 'Kein Zugriff, keine Unterlage'], ['L2-Autorisierungen', '0', 'L2 bleibt geschlossen']],
    badge: 'BESTÄTIGT',
    ...
    packages: [
      {
        id: 'REF-01-G1-PKG-01-001', version: 'V1.0', title: 'Rollen und Sichtbarkeit', icon: KeyRound,
      ...
      {
        id: 'REF-01-G1-PKG-02-001', version: 'V1.0', title: 'Aufbewahrung und DMS', icon: Archive,
    ...
    status: 'BESTÄTIGT · Zwei gesteuerte Träger, null Inhaber, null Zugriff, null erfundene Fristen und null geänderte Unterlagen.',
    next: 'Nachfolgend erfasster Entscheid: REF-01-DEC-030 bestätigt PKG-01-001 V1.0 und PKG-02-001 V1.0 gemeinsam.',
    boundary: 'Die Bestätigung der Matrizen gewährt kein Recht und erlaubt keine Operation an realen Unterlagen.'
  }
};
