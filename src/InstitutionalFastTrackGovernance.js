...
const COPY = {
  FR: {
    ...
    counters: [['Lot courant', '22', 'Valeurs traitées ensemble'], ['Confirmables', '9', 'Observations suffisamment sourcées'], ['Exceptions', '13', '8 partielles · 5 ouvertes'], ['Décisions Fast Track', '6', 'DEC-067 à DEC-072 enregistrées']],
    steps: [
  ...
  EN: {
    ...
    counters: [['Current package', '22', 'Values handled together'], ['Confirmable', '9', 'Sufficiently sourced observations'], ['Exceptions', '13', '8 partial · 5 open'], ['Fast Track decisions', '6', 'DEC-067 through DEC-072 recorded']],
  ...
  DE: {
    ...
    counters: [['Aktuelles Paket', '22', 'Gemeinsam behandelte Werte'], ['Bestätigbar', '9', 'Ausreichend belegte Beobachtungen'], ['Ausnahmen', '13', '8 teilweise · 5 offen'], ['Fast-Track-Entscheide', '6', 'DEC-067 bis DEC-072 erfasst']],
