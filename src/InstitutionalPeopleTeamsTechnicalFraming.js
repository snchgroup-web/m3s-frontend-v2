...
const COPY = {
  FR: {
    eyebrow: 'CADRAGE TECHNIQUE CANDIDAT · REF-01-ML-001 · V0.1 · 26-08-2026',
    ...
    status: 'Statut : cadrage technique candidat V0.1 préparé ; aucun choix technique n’est validé ni appliqué.',
    next: 'Prochain arbitrage : confirmer, corriger ou rejeter ce cadrage candidat avant toute proposition d’implémentation.',
  ...
  EN: {
    eyebrow: 'CANDIDATE TECHNICAL FRAMING · REF-01-ML-001 · V0.1 · 26 AUG 2026',
    ...
    status: 'Status: candidate technical framing V0.1 prepared; no technical choice is validated or applied.',
    next: 'Next review: confirm, amend or reject this candidate framing before any implementation proposal.',
  ...
  DE: {
    eyebrow: 'TECHNISCHE KANDIDATENAUSGESTALTUNG · REF-01-ML-001 · V0.1 · 26.08.2026',
    ...
    status: 'Stand: technische Kandidatenausgestaltung V0.1 vorbereitet; keine technische Wahl validiert oder angewendet.',
    next: 'Nächster Entscheid: Diese Kandidatenausgestaltung vor jedem Umsetzungsvorschlag bestätigen, ändern oder ablehnen.',
