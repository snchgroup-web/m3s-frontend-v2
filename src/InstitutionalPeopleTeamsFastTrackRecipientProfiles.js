...
const COPY = {
  FR: {
    ...
    decision: 'REC-002 V1.0 gouverne désormais les cinq profils. NAM-002 V0.1, présenté ensuite, prépare cinq emplacements nominatifs vides sans inscrire personne.',
  ...
  EN: {
    ...
    decision: 'REC-002 V1.0 now governs the five profiles. NAM-002 V0.1, shown next, prepares five empty named-recipient slots without entering anyone.',
  ...
  DE: {
    ...
    decision: 'REC-002 V1.0 steuert nun die fünf Profile. Das nachfolgende NAM-002 V0.1 bereitet fünf leere Namensstellen vor, ohne jemanden einzutragen.',
