...
const COPY = {
  FR: {
    eyebrow: 'PROPOSITION CANDIDATE · VALIDATION HUMAINE REQUISE',
    title: 'Base d’arbitrage CNS-01 prête à examiner',
    body: 'Cette proposition traduit le cadrage publié en quatre décisions concrètes. Elle peut être validée comme cadre de travail sans déclarer 2SG conforme, sans adopter un texte et sans accepter un risque juridique.',
    cards: [
      {
      ...
      {
        title: 'Règle de calcul proposée',
    ...
    decisionTitle: 'Ce que Cheikh peut valider maintenant',
    decision: 'Valider cette base comme cadre de travail CNS-01. Cette validation autorise la préparation de l’inventaire détaillé, mais ne vaut ni adoption institutionnelle, ni déclaration de conformité, ni acceptation d’un risque juridique.',
    ...
    source: 'Sources : CNS-01 publié, MEP-01 LEGAL, MEP-02 Gouvernance, pilote Administration, registre Conformité et règles de gouvernance 2SG consignées. Statut : proposition candidate, non validée.'
  },
  EN: {
    eyebrow: 'CANDIDATE PROPOSAL · HUMAN VALIDATION REQUIRED',
    title: 'CNS-01 decision baseline ready for review',
    body: 'This proposal turns the published framework into four concrete decisions. It may be validated as a working framework without declaring 2SG compliant, adopting a document or accepting legal risk.',
    cards: [
      {
      ...
      {
        title: 'Proposed calculation rule',
    ...
    decisionTitle: 'What Cheikh may validate now',
    decision: 'Validate this baseline as the CNS-01 working framework. This authorises preparation of the detailed inventory, but is neither institutional adoption, a compliance declaration nor acceptance of legal risk.',
    ...
    source: 'Sources: published CNS-01, MEP-01 LEGAL, MEP-02 Governance, Administration pilot, Compliance register and recorded 2SG governance rules. Status: candidate proposal, not validated.'
  },
  DE: {
    eyebrow: 'KANDIDATENVORSCHLAG · MENSCHLICHE VALIDIERUNG ERFORDERLICH',
    title: 'Entscheidungsgrundlage CNS-01 zur Prüfung bereit',
    body: 'Dieser Vorschlag übersetzt die veröffentlichte Strukturierung in vier konkrete Entscheide. Er kann als Arbeitsrahmen validiert werden, ohne 2SG für konform zu erklären, ein Dokument zu verabschieden oder ein Rechtsrisiko zu akzeptieren.',
    cards: [
      {
      ...
      {
        title: 'Vorgeschlagene Berechnungsregel',
    ...
    decisionTitle: 'Was Cheikh jetzt validieren kann',
    decision: 'Diese Grundlage als Arbeitsrahmen für CNS-01 validieren. Dies erlaubt die Vorbereitung des Detailinventars, ist aber weder institutionelle Verabschiedung noch Konformitätserklärung oder Annahme eines Rechtsrisikos.',
    ...
    source: 'Quellen: veröffentlichtes CNS-01, MEP-01 LEGAL, MEP-02 Governance, Pilot Administration, Compliance-Register und dokumentierte 2SG-Governance-Regeln. Status: Kandidatenvorschlag, nicht validiert.'
  }
};
