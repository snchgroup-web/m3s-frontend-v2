...
const COPY = {
  FR: {
    ...
    next: 'Étapes suivantes accomplies : IDN-001 et PRI-001 sont confirmés en V1.0 ; SEL-001 V0.1 prépare maintenant le choix documentaire entre AUT-A, B, C et D.',
  ...
  EN: {
    ...
    next: 'Next steps completed: IDN-001 and PRI-001 are confirmed as V1.0; SEL-001 V0.1 now prepares documentary selection across AUT-A, B, C and D.',
  ...
  DE: {
    ...
    next: 'Nächste Schritte abgeschlossen: IDN-001 und PRI-001 sind als V1.0 bestätigt; SEL-001 V0.1 bereitet nun die dokumentarische Auswahl zwischen AUT-A, B, C und D vor.',
