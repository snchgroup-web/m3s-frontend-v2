...
const COPY = {
  FR: {
    eyebrow: 'RESPONSABILITÉS ET DÉCLENCHEURS · CANDIDAT V0.1 · 28-08-2026',
    title: 'Attribuer le pilotage sans lancer la conservation',
    intro: 'La désignation V1.0 fixe les cinq catégories. Cette fiche candidate attribue maintenant leur pilotage à des fonctions et décrit les événements qui devront ouvrir un contrôle documenté, jamais une suppression ou un archivage automatique.',
    counters: [['Catégories couvertes', '5/5', 'Même périmètre que la désignation V1.0'], ['Responsables fonctionnels', '5/5', 'Fonctions candidates, sans mandat nominatif'], ['Automatisations ouvertes', '0', 'Chaque événement ouvre seulement un contrôle'], ['Opérations GED', '0', 'Aucune pièce déplacée ou supprimée']],
    labels: { category: 'Catégorie', accountable: 'Fonction pilote candidate', stewards: 'Contributeurs et gardiens', triggers: 'Déclencheurs documentaires candidats', gate: 'Contrôle humain obligatoire' },
    ...
    status: 'CANDIDAT · Cinq fonctions pilotes proposées. Zéro mandat nominatif, règle automatique ou opération GED.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-03-005 V0.1. Une confirmation attribuera des responsabilités fonctionnelles, pas des droits techniques.',
  ...
  EN: {
    eyebrow: 'OWNERSHIP AND TRIGGERS · V0.1 CANDIDATE · 28 AUG 2026',
    title: 'Assign stewardship without starting retention',
    intro: 'The V1.0 designation fixes the five categories. This candidate file now assigns their stewardship to functions and describes events that must open a documented review, never an automatic deletion or archive.',
    counters: [['Categories covered', '5/5', 'Same scope as the V1.0 designation'], ['Responsible functions', '5/5', 'Candidate functions, no named mandate'], ['Automations opened', '0', 'Each event opens only a review'], ['DMS operations', '0', 'No record moved or deleted']],
    labels: { category: 'Category', accountable: 'Candidate lead function', stewards: 'Contributors and custodians', triggers: 'Candidate documentary triggers', gate: 'Mandatory human control' },
    ...
    status: 'CANDIDATE · Five lead functions proposed. Zero named mandate, automated rule or DMS operation.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-03-005 V0.1. Confirmation will assign functional responsibilities, not technical rights.',
  ...
  DE: {
    eyebrow: 'VERANTWORTUNG UND AUSLÖSER · KANDIDAT V0.1 · 28.08.2026',
    title: 'Verantwortung zuweisen, ohne Aufbewahrung zu starten',
    intro: 'Die Zuordnung V1.0 legt die fünf Kategorien fest. Diese Kandidatenakte weist ihre Steuerung Funktionen zu und beschreibt Ereignisse, die eine dokumentierte Prüfung öffnen müssen, niemals eine automatische Löschung oder Archivierung.',
    counters: [['Abgedeckte Kategorien', '5/5', 'Gleicher Umfang wie Zuordnung V1.0'], ['Verantwortliche Funktionen', '5/5', 'Kandidatenfunktionen ohne Namensmandat'], ['Geöffnete Automatisierungen', '0', 'Jedes Ereignis öffnet nur eine Prüfung'], ['DMS-Operationen', '0', 'Keine Unterlage verschoben oder gelöscht']],
    labels: { category: 'Kategorie', accountable: 'Verantwortliche Kandidatenfunktion', stewards: 'Mitwirkende und Verwahrende', triggers: 'Dokumentarische Kandidatenauslöser', gate: 'Obligatorische menschliche Kontrolle' },
    ...
    status: 'KANDIDAT · Fünf verantwortliche Funktionen vorgeschlagen. Null Namensmandat, automatisierte Regel oder DMS-Operation.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-03-005 V0.1 bestätigen oder ändern. Eine Bestätigung weist funktionale Verantwortung, keine technischen Rechte zu.',
...
const InstitutionalPeopleTeamsGateG1RetentionOwnersTriggers = ({ language = 'FR' }) => {
  ...
  return (
    <section data-testid="ref01-g1-retention-owners-triggers" className="mt-4 rounded-md border border-violet-800/70 bg-violet-950/10 p-3 sm:p-4" aria-labelledby="ref01-g1-retention-owners-triggers-title">
      ...
      <article className="mt-4 m3s-raised p-3 sm:p-4"><div className="flex flex-wrap items-start justify-between gap-2"><h6 className="break-words text-sm font-semibold text-slate-100">REF-01-G1-AUT-02-03-005 · V0.1</h6><span className="rounded-md border border-amber-700/70 bg-amber-950/25 px-2 py-1 text-[10px] font-semibold text-amber-100">{t.badge}</span></div>
