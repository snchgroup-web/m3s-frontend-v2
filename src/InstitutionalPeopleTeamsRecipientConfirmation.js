...
const COPY = {
  FR: {
    ...
    next: 'Prochaine étape : préparer les emplacements nominatifs vides, puis soumettre séparément chaque inscription réelle à autorisation humaine.',
  ...
  EN: {
    ...
    next: 'Next step: prepare empty named-recipient slots, then submit each real entry separately for human authorisation.',
  ...
  DE: {
    ...
    next: 'Nächster Schritt: leere Stellen für benannte Empfänger vorbereiten und danach jeden realen Eintrag getrennt menschlich autorisieren lassen.',
