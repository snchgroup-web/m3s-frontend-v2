...
test('frames Finance with real sources, responsibilities and prudent boundaries', () => {
  ...
  expect(screen.getByRole('heading', { name: 'Tracer les ressources, les engagements et les preuves financières' })).toBeInTheDocument();
  ...
  expect(screen.getByRole('heading', { name: 'Ressourcen, Verpflichtungen und Finanznachweise nachvollziehen' })).toBeInTheDocument();
