...
const COPY = {
  FR: {
    eyebrow: 'PREMIERE EXECUTION · FICHE V1.0 CONFIRMÉE · 29-08-2026',
    title: 'Préparer un GO ou NO-GO sans exécuter le droit',
    intro: 'Cette fiche vide confirmée prépare la décision humaine séparée exigée après le protocole 009 V1.0. Elle ne crée ni autorisation active, ni titulaire, ni compte, ni droit et ne permet aucune action technique.',
    ...
    rulesTitle: 'Cinq règles de décision confirmées',
    ...
    status: 'CONFIRMÉ · Fiche documentaire V1.0. Zéro décision active, titulaire réel, compte, droit, accès C3/C4/C5 ou action technique.',
    next: 'Sous-lot Rôles et moindre privilège préparé. La revue candidate REF-01-G1-REV-004 V0.1 réévalue maintenant les six conditions G1.',
  ...
  EN: {
    eyebrow: 'FIRST EXECUTION · V1.0 CONFIRMED SHEET · 29 AUG 2026',
    title: 'Prepare a GO or NO-GO without executing the right',
    intro: 'This confirmed empty sheet prepares the separate human decision required after protocol 009 V1.0. It creates no active authorisation, holder, account or right and enables no technical action.',
    ...
    rulesTitle: 'Five confirmed decision rules',
    ...
    status: 'CONFIRMED · V1.0 documentary sheet. Zero active decisions, real holders, accounts, rights, C3/C4/C5 access or technical actions.',
    next: 'Roles and least privilege sub-package prepared. Candidate review REF-01-G1-REV-004 V0.1 now reassesses all six G1 conditions.',
  ...
  DE: {
    eyebrow: 'ERSTE AUSFUEHRUNG · BESTÄTIGTES BLATT V1.0 · 29.08.2026',
    title: 'GO oder NO-GO vorbereiten, ohne das Recht auszuführen',
    intro: 'Dieses bestätigte leere Blatt bereitet den getrennten menschlichen Entscheid nach Protokoll 009 V1.0 vor. Es erstellt weder aktive Autorisierung, Inhaber, Konto noch Recht und ermöglicht keine technische Aktion.',
    ...
    rulesTitle: 'Fünf bestätigte Entscheidregeln',
    ...
    status: 'BESTÄTIGT · Dokumentationsblatt V1.0. Null aktive Entscheide, reale Inhaber, Konten, Rechte, C3/C4/C5-Zugriffe oder technische Aktionen.',
    next: 'Teilpaket Rollen und geringste Berechtigung vorbereitet. Die Kandidatenprüfung REF-01-G1-REV-004 V0.1 bewertet nun alle sechs G1-Bedingungen neu.',
