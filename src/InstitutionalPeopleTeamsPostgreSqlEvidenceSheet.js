...
const COPY = {
  FR: {
    ...
    next: 'REF-01-G1-COL-001 V1.0 gouverne la collecte ; REQ-001 V1.0 les demandes ; REC-001 V1.0 les profils ; NAM-001 V0.1 prépare des emplacements vides sans nom ni envoi.',
  ...
  EN: {
    ...
    next: 'REF-01-G1-COL-001 V1.0 governs collection; REQ-001 V1.0 requests; REC-001 V1.0 profiles; NAM-001 V0.1 prepares empty slots without names or sends.',
  ...
  DE: {
    ...
    next: 'REF-01-G1-COL-001 V1.0 steuert die Sammlung; REQ-001 V1.0 Anfragen; REC-001 V1.0 Profile; NAM-001 V0.1 bereitet leere Stellen ohne Namen oder Versand vor.',
