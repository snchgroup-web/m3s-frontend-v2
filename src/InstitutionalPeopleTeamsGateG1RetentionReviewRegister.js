...
const COPY = {
  FR: {
    ...
    next: 'Les six portes d’ouverture de REF-01-G1-AUT-02-03-008 V1.0 sont confirmées par REF-01-DEC-048, sans ouvrir de cas réel.',
  ...
  EN: {
    ...
    next: 'The six opening gates in REF-01-G1-AUT-02-03-008 V1.0 are confirmed by REF-01-DEC-048, without opening a real case.',
  ...
  DE: {
    ...
    next: 'Die sechs Öffnungstore in REF-01-G1-AUT-02-03-008 V1.0 sind durch REF-01-DEC-048 bestätigt, ohne einen realen Fall zu eröffnen.',
