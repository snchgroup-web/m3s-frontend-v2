...
const COPY = {
  FR: {
    eyebrow: 'REGISTRE DES REVUES DE CONSERVATION · CANDIDAT V0.1 · 28-08-2026',
    ...
    status: 'CANDIDAT · Registre vide préparé. Zéro cas réel, affectation nominative, donnée C3/C4, délai appliqué ou opération.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-03-007 V0.1.',
  ...
  EN: {
    eyebrow: 'RETENTION REVIEW REGISTER · V0.1 CANDIDATE · 28 AUG 2026',
    ...
    status: 'CANDIDATE · Empty register prepared. Zero real cases, named assignments, C3/C4 data, applied periods or operations.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-03-007 V0.1.',
  ...
  DE: {
    eyebrow: 'REGISTER DER AUFBEWAHRUNGSPRÜFUNGEN · KANDIDAT V0.1 · 28.08.2026',
    ...
    status: 'KANDIDAT · Leeres Register vorbereitet. Null reale Fälle, Namenszuweisungen, C3/C4-Daten, angewandte Fristen oder Operationen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-03-007 V0.1 bestätigen oder ändern.',
