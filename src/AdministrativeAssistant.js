...
import ExternalMissionRegister from './ExternalMissionRegister';
...
const AdministrativeAssistant = ({ language = 'FR' }) => {
  ...
  const prepareTemplate = template => {
    ...
    setPreparedTemplateId(template.id);
