...
const COPY = {
  FR: {
    ...
    task: 'Type de soutien', context: 'Contexte minimal', source: 'Source ou emplacement GED', result: 'Projet de consigne contrôlée', copy: 'Copier la consigne', copied: 'Consigne copiée.',
...
const AdministrativeAssistant = ({ language = 'FR' }) => {
  ...
  const [task, setTask] = useState(t.tasks[0]);
