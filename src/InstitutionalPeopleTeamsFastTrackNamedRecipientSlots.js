...
const COPY = {
  FR: {
    ...
    decision: 'NAM-002 V1.0 gouverne les cinq emplacements vides. DEC-072 confirme désormais AUT-003 V1.0 comme cinq dossiers d’autorisation également vides et non exécutoires.',
  ...
  EN: {
    ...
    decision: 'NAM-002 V1.0 governs the five empty slots. DEC-072 now confirms AUT-003 V1.0 as five authorisation files that are also empty and non-executable.',
  ...
  DE: {
    ...
    decision: 'NAM-002 V1.0 steuert die fünf leeren Stellen. DEC-072 bestätigt nun AUT-003 V1.0 als fünf ebenfalls leere und nicht ausführbare Autorisierungsakten.',
