...
const COPY = {
  FR: {
    ...
    decision: 'NAM-002 V1.0 gouverne désormais les cinq emplacements vides. AUT-002 V0.1, présenté ensuite, prépare cinq dossiers d’autorisation également vides et non exécutoires.',
  ...
  EN: {
    ...
    decision: 'NAM-002 V1.0 now governs the five empty slots. AUT-002 V0.1, shown next, prepares five authorisation files that are also empty and non-executable.',
  ...
  DE: {
    ...
    decision: 'NAM-002 V1.0 steuert nun die fünf leeren Stellen. Das nachfolgende AUT-002 V0.1 bereitet fünf ebenfalls leere und nicht ausführbare Autorisierungsakten vor.',
