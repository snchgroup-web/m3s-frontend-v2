...
const COPY = {
  FR: {
    eyebrow: 'RÔLES ET MOINDRE PRIVILÈGE · MODÈLE CANDIDAT V0.1 · 28-08-2026',
    ...
    status: 'CANDIDAT · Modèle documentaire vide. Zéro création de compte, attribution, retrait, délégation, exception, accès C3/C4/C5 ou modification de production.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-02-003 V0.1.',
  ...
  EN: {
    eyebrow: 'ROLES AND LEAST PRIVILEGE · V0.1 CANDIDATE MODEL · 28 AUG 2026',
    ...
    status: 'CANDIDATE · Empty documentary model. Zero account creation, assignment, withdrawal, delegation, exception, C3/C4/C5 access or production change.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-02-003 V0.1.',
  ...
  DE: {
    eyebrow: 'ROLLEN UND GERINGSTE BERECHTIGUNG · KANDIDATENMODELL V0.1 · 28.08.2026',
    ...
    status: 'KANDIDAT · Leeres Dokumentationsmodell. Null Kontoerstellungen, Zuweisungen, Entzüge, Delegationen, Ausnahmen, C3/C4/C5-Zugriffe oder Produktionsänderungen.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-02-003 V0.1 bestätigen oder ändern.',
