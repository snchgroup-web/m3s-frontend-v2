...
const COPY = {
  FR: {
    ...
    record: { id: 'REF-01-DEC-077', version: 'V1.0', status: 'Résultats synthétiques acceptés · lot fictif clos', author: 'Cheikh Ndiaye', date: '31-08-2026', decision: 'Les résultats des six cas fictifs de M3S-INB-002 V1.0 sont acceptés après relecture humaine. Le lot synthétique est clos sans ouverture opérationnelle ni L2.', evidence: 'Acceptation explicite de Cheikh dans la session du 31-08-2026 : « Acceptés, merci de continuer mon cher ». Cette acceptation porte sur les six résultats synthétiques présentés après leur exécution technique réussie.', limit: 'L’acceptation clôt uniquement le lot fictif. Elle n’autorise aucune donnée réelle, connexion, import, automatisme, persistance opérationnelle, accès, dépense, production, mise en service ou action L2.' },
    ...
    nextTitle: 'Prochain focus G1',
    next: 'Revenir aux cinq valeurs ouvertes et aux huit valeurs partielles de G1 afin de collecter uniquement les preuves manquantes. Aucun lot réel ni L2 n’est ouvert.',
    pilotEyebrow: 'PROTOCOLE CONFIRMÉ · M3S-INB-002 · V1.0 · 31-08-2026',
    pilotTitle: 'Pilote synthétique isolé · six cas acceptés, lot clos',
    ...
    pilotDecisionTitle: 'Décisions enregistrées · exécution et acceptation',
    pilotDecision: 'REF-01-DEC-076 autorise l’exécution fictive ; REF-01-DEC-077 accepte séparément les six résultats et clôt le lot. Toute donnée réelle ou capacité opérationnelle reste interdite.',
    pilotVerdict: 'STATUT · LOT SYNTHÉTIQUE ACCEPTÉ ET CLOS. 6/6 cas réussis, 5/5 critères techniques vérifiés, relecture humaine acceptée et zéro donnée réelle.',
    criteriaLabels: { passed: 'Vérifié', accepted: 'Accepté' },
    ...
    reviewPending: 'RELECTURE HUMAINE ACCEPTÉE · Les six résultats synthétiques sont consignés comme preuve de test. Cette acceptation n’ouvre aucun traitement réel ni L2.',
    ...
    gateCounters: [['Options sélectionnées', '1/2', 'GO limité'], ['Cas autorisés', '6/6', 'Périmètre fictif uniquement'], ['Cas acceptés', '6/6', 'Lot synthétique clos'], ['Actions L2', '0', 'G1 reste ouverte']],
    ...
    gateRule: 'RÈGLE · L’acceptation du lot fictif ne vaut ni mise en service ni ouverture L2. Tout traitement réel exige une nouvelle décision explicite.',
    verdict: 'STATUT · LOT FICTIF EXÉCUTÉ, ACCEPTÉ ET CLOS. Zéro entrée réelle, import, connecteur, persistance ou action L2.'
  },
  EN: {
    ...
    record: { id: 'REF-01-DEC-077', version: 'V1.0', status: 'Synthetic results accepted · fictional package closed', author: 'Cheikh Ndiaye', date: '31 Aug 2026', decision: 'The results of the six fictional M3S-INB-002 V1.0 cases are accepted after human review. The synthetic package is closed without operational or L2 opening.', evidence: 'Cheikh’s explicit acceptance in the 31 Aug 2026 session, retained in its original wording: “Acceptés, merci de continuer mon cher”. This acceptance applies to the six synthetic results presented after their successful technical execution.', limit: 'The acceptance closes only the fictional package. It authorises no real data, connection, import, automation, operational persistence, access, expense, production, activation or L2 action.' },
    ...
    nextTitle: 'Next G1 focus',
    next: 'Return to the five open and eight partial G1 values and collect only the missing evidence. No real or L2 package is open.',
    pilotEyebrow: 'CONFIRMED PROTOCOL · M3S-INB-002 · V1.0 · 31 AUG 2026',
    pilotTitle: 'Isolated synthetic pilot · six cases accepted, package closed',
    pilotVersion: 'V1.0 · 6/6',
    ...
    pilotDecisionTitle: 'Recorded decisions · execution and acceptance',
    pilotDecision: 'REF-01-DEC-076 authorises fictional execution; REF-01-DEC-077 separately accepts all six results and closes the package. Any real data or operational capability remains prohibited.',
    pilotVerdict: 'STATUS · SYNTHETIC PACKAGE ACCEPTED AND CLOSED. 6/6 cases passed, 5/5 technical criteria verified, human review accepted and zero real data.',
    criteriaLabels: { passed: 'Verified', accepted: 'Accepted' },
    ...
    reviewPending: 'HUMAN REVIEW ACCEPTED · The six synthetic results are recorded as test evidence. This acceptance opens no real processing or L2.',
    ...
    gateCounters: [['Selected options', '1/2', 'Limited GO'], ['Authorised cases', '6/6', 'Fictional scope only'], ['Accepted cases', '6/6', 'Synthetic package closed'], ['L2 actions', '0', 'G1 remains open']],
    ...
    gateRule: 'RULE · Acceptance of the fictional package is neither activation nor L2 opening. Any real processing requires a new explicit decision.',
    verdict: 'STATUS · FICTIONAL PACKAGE RUN, ACCEPTED AND CLOSED. Zero real entries, imports, connectors, persistence or L2 actions.'
  },
  DE: {
    ...
    record: { id: 'REF-01-DEC-077', version: 'V1.0', status: 'Synthetische Ergebnisse angenommen · fiktives Los geschlossen', author: 'Cheikh Ndiaye', date: '31.08.2026', decision: 'Die Ergebnisse der sechs fiktiven Fälle von M3S-INB-002 V1.0 werden nach menschlicher Prüfung angenommen. Das synthetische Los wird ohne operative oder L2-Öffnung geschlossen.', evidence: 'Ausdrückliche Annahme durch Cheikh in der Sitzung vom 31.08.2026, im französischen Originalwortlaut festgehalten: „Acceptés, merci de continuer mon cher“. Diese Annahme betrifft die sechs nach erfolgreicher technischer Ausführung vorgelegten synthetischen Ergebnisse.', limit: 'Die Annahme schliesst nur das fiktive Los. Sie erlaubt keine realen Daten, Verbindung, Importe, Automatismen, operative Speicherung, Zugriffe, Ausgaben, Produktion, Inbetriebnahme oder L2-Aktion.' },
    ...
    nextTitle: 'Nächster G1-Fokus',
    next: 'Zu den fünf offenen und acht teilweisen G1-Werten zurückkehren und nur die fehlenden Nachweise sammeln. Kein reales oder L2-Los ist geöffnet.',
    pilotEyebrow: 'BESTÄTIGTES PROTOKOLL · M3S-INB-002 · V1.0 · 31.08.2026',
    pilotTitle: 'Isolierter synthetischer Pilot · sechs Fälle angenommen, Los geschlossen',
    pilotVersion: 'V1.0 · 6/6',
    ...
    pilotDecisionTitle: 'Erfasste Entscheide · Ausführung und Annahme',
    pilotDecision: 'REF-01-DEC-076 autorisiert die fiktive Ausführung; REF-01-DEC-077 nimmt die sechs Ergebnisse getrennt an und schliesst das Los. Reale Daten oder operative Fähigkeiten bleiben verboten.',
    pilotVerdict: 'STATUS · SYNTHETISCHES LOS ANGENOMMEN UND GESCHLOSSEN. 6/6 Fälle erfolgreich, 5/5 technische Kriterien geprüft, menschliche Prüfung angenommen und null reale Daten.',
    criteriaLabels: { passed: 'Geprüft', accepted: 'Angenommen' },
    ...
    reviewPending: 'MENSCHLICHE PRÜFUNG ANGENOMMEN · Die sechs synthetischen Ergebnisse sind als Testnachweis erfasst. Diese Annahme öffnet keine reale Verarbeitung und kein L2.',
    ...
    gateCounters: [['Gewählte Optionen', '1/2', 'Begrenztes GO'], ['Autorisierte Fälle', '6/6', 'Nur fiktiver Umfang'], ['Angenommene Fälle', '6/6', 'Synthetisches Los geschlossen'], ['L2-Aktionen', '0', 'G1 bleibt offen']],
    ...
    gateRule: 'REGEL · Die Annahme des fiktiven Loses ist weder Inbetriebnahme noch L2-Öffnung. Jede reale Verarbeitung benötigt einen neuen ausdrücklichen Entscheid.',
    verdict: 'STATUS · FIKTIVES LOS AUSGEFÜHRT, ANGENOMMEN UND GESCHLOSSEN. Null reale Eingänge, Importe, Connectoren, Speicherung oder L2-Aktionen.'
  }
};
  ...
  return (
    <section id="institutional-m3s-inbox-frame" data-testid="institutional-m3s-inbox-frame" className="scroll-mt-24 rounded-md border border-violet-800/70 bg-violet-950/10 p-3 sm:p-4">
      ...
      <section data-testid="institutional-m3s-inbox-pilot-spec" className="m3s-inbox-pilot-spec mt-4 rounded-md border border-sky-800/70 bg-sky-950/10 p-3 sm:p-4" aria-labelledby="institutional-m3s-inbox-pilot-title">
        ...
        <article className="m3s-raised mt-4 p-3 sm:p-4"><h6 className="text-sm font-semibold text-slate-100">{t.criteriaTitle}</h6><ul className="mt-3 grid grid-cols-1 gap-2 lg:grid-cols-2">{t.criteria.map((item, index) => { const technical = index < execution.summary.technicalCriteriaPassed; return <li key={item} className="flex items-start gap-2 rounded-md border border-slate-700 bg-slate-950/20 p-3 text-xs leading-5 text-slate-300"><span className="mt-0.5 inline-flex min-h-6 shrink-0 items-center gap-1 rounded-md border border-emerald-700/70 bg-emerald-950/25 px-2 py-0.5 text-[11px] font-semibold text-emerald-200"><CheckCircle2 size={13} aria-hidden="true" />{technical ? t.criteriaLabels.passed : t.criteriaLabels.accepted}</span><span>{item}</span></li>; })}</ul></article>
        <section data-testid="institutional-m3s-inbox-pilot-results" className="mt-4 rounded-md border border-emerald-800/70 bg-emerald-950/10 p-3 sm:p-4" aria-labelledby="institutional-m3s-inbox-pilot-results-title">
          ...
          <p className="mt-4 flex items-start gap-2 rounded-md border border-emerald-800/70 bg-emerald-950/15 p-3 text-sm font-semibold leading-6 text-emerald-100"><CheckCircle2 className="mt-0.5 shrink-0 text-emerald-300" size={17} aria-hidden="true" />{t.reviewPending}</p>
        </section>
