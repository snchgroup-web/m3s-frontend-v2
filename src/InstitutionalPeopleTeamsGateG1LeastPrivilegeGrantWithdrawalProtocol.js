...
const COPY = {
  FR: {
    eyebrow: 'ATTRIBUTION ET RETRAIT · PROTOCOLE CONFIRMÉ V1.0 · 29-08-2026',
    title: 'Préparer chaque changement de droit sans l’exécuter',
    intro: 'Ce protocole confirmé structure une future demande d’attribution, modification, expiration ou retrait. Il sépare besoin métier, validation, exécution technique et preuve, sans créer de compte ni modifier un droit réel.',
    ...
    next: 'Suite préparée : confirmer ou amender le registre d’habilitations vide REF-01-G1-AUT-02-02-006 V0.1.',
  ...
  EN: {
    eyebrow: 'GRANT AND WITHDRAWAL · V1.0 CONFIRMED PROTOCOL · 29 AUG 2026',
    title: 'Prepare every right change without executing it',
    intro: 'This confirmed protocol structures a future grant, change, expiry or withdrawal request. It separates business need, approval, technical execution and evidence without creating an account or changing a real right.',
    ...
    next: 'Prepared next step: confirm or amend the empty access-rights register REF-01-G1-AUT-02-02-006 V0.1.',
  ...
  DE: {
    eyebrow: 'ZUWEISUNG UND ENTZUG · BESTÄTIGTES PROTOKOLL V1.0 · 29.08.2026',
    title: 'Jede Rechteänderung vorbereiten, ohne sie auszuführen',
    intro: 'Dieses bestätigte Protokoll strukturiert eine künftige Zuweisung, Änderung, Befristung oder einen Entzug. Es trennt Fachbedarf, Genehmigung, technische Ausführung und Nachweis, ohne ein Konto zu erstellen oder ein reales Recht zu ändern.',
    ...
    next: 'Nächster vorbereiteter Schritt: das leere Berechtigungsregister REF-01-G1-AUT-02-02-006 V0.1 bestätigen oder ändern.',
