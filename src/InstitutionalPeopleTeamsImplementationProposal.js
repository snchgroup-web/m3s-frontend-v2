...
const COPY = {
  FR: {
    eyebrow: 'PROPOSITION D’IMPLEMENTATION CANDIDATE · REF-01-IMP-001 · V0.1 · 26-08-2026',
    ...
    optionBadge: 'RECOMMANDATION · A VALIDER',
    ...
    status: 'Statut : proposition d’implémentation V0.1 préparée ; aucune exécution, estimation ou sélection d’infrastructure n’est validée.',
    next: 'Prochain arbitrage : confirmer, corriger ou rejeter l’option d’architecture, les six lots et les quatre portes avant toute implémentation.',
  ...
  EN: {
    eyebrow: 'CANDIDATE IMPLEMENTATION PROPOSAL · REF-01-IMP-001 · V0.1 · 26 AUG 2026',
    ...
    status: 'Status: implementation proposal V0.1 prepared; no execution, estimate or infrastructure choice is validated.', next: 'Next review: confirm, amend or reject the architecture option, six packages and four gates before any implementation.', boundary: 'Boundary: zero table, API, permission, secret, real data, migration, deployment, automation, master source or progress is created by this proposal.'
  },
  DE: {
    eyebrow: 'KANDIDAT FÜR UMSETZUNGSVORSCHLAG · REF-01-IMP-001 · V0.1 · 26.08.2026',
    ...
    status: 'Stand: Umsetzungsvorschlag V0.1 vorbereitet; keine Ausführung, Schätzung oder Infrastrukturwahl ist validiert.', next: 'Nächster Entscheid: Architekturoption, sechs Lose und vier Entscheidpunkte vor jeder Umsetzung bestätigen, ändern oder ablehnen.', boundary: 'Grenze: Null Tabellen, APIs, Berechtigungen, Geheimnisse, reale Daten, Migrationen, Bereitstellungen, Automatisierungen, Masterquellen oder Fortschritt werden durch diesen Vorschlag erstellt.'
  }
};
