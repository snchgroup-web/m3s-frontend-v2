...
const COPY = {
  FR: {
    eyebrow: 'CAS DE REVUE DE CONSERVATION · CANDIDAT V0.1 · 28-08-2026',
    ...
    status: 'CANDIDAT · Cinq cas de revue préparés. Zéro affectation nominative, échéance calculée ou opération exécutée.',
    next: 'Prochain arbitrage humain : confirmer ou amender REF-01-G1-AUT-02-03-006 V0.1. Une confirmation validera le protocole de revue, pas son exécution.',
  ...
  EN: {
    eyebrow: 'RETENTION REVIEW CASES · V0.1 CANDIDATE · 28 AUG 2026',
    ...
    status: 'CANDIDATE · Five review cases prepared. Zero named assignment, calculated deadline or executed operation.',
    next: 'Next human decision: confirm or amend REF-01-G1-AUT-02-03-006 V0.1. Confirmation will validate the review protocol, not its execution.',
  ...
  DE: {
    eyebrow: 'AUFBEWAHRUNGS-PRÜFFÄLLE · KANDIDAT V0.1 · 28.08.2026',
    ...
    status: 'KANDIDAT · Fünf Prüffälle vorbereitet. Null namentliche Zuweisung, berechnete Frist oder ausgeführte Operation.',
    next: 'Nächster menschlicher Entscheid: REF-01-G1-AUT-02-03-006 V0.1 bestätigen oder ändern. Eine Bestätigung validiert das Prüfprotokoll, nicht seine Ausführung.',
